...
<html>
  <head>
    ...
    <title>Ddd-service Rest API Documentation</title>
  ...
  <body class="skin-blue fixed" data-spy="scroll" data-target="#scrollspy">
    <div class="wrapper">
      ...
      <header class="main-header">
        <!-- Logo -->
        <a style="font-size: 13px;" href="<?=base_url();?>api/ddd-service/doc" class="logo"><b>Ddd-service Restful API</b></a>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar" id="scrollspy">
          ...
          <ul class="nav sidebar-menu">
            ...
            <li><a href="#list_user"><i class='fa fa-circle-o'></i> GET /api/ddd-service</a></li>
            <li><a href="#detail_user"><i class='fa fa-circle-o'></i> GET /api/ddd-service/:id</a></li>
            <li><a href="#search"><i class='fa fa-circle-o'></i> GET /api/ddd-service/search/:search keyword</a></li>
            <li><a href="#token"><i class='fa fa-circle-o'></i> Key Token</a></li>
            <li><a href="#post_user"><i class='fa fa-circle-o'></i> POST /api/ddd-service</a></li>
            <li><a href="#update"><i class='fa fa-circle-o'></i> PUT /api/ddd-service/update/:id</a></li>
      ...
      <div class="content-wrapper">
        ...
        <div class="content-header">
          <h1>
            Ddd-service Rest API Documentation
...
<section id='overview'>
  ...
  <p class='lead'>
    This is auto-generated document for <b>ddd-service Rest API</b> that you can use to query ddd-service data, search ddd-service, update ddd-service, and delete ddd-service data.
  </p>
...
<section id="method">
  ...
  <p class="lead"></p>
    ...
    <td><?=base_url();?>api/ddd-service</td>
    <td>Retrieve all ddd-service</td>
    </tr>
     <tr class="row-even"><td>GET</td>
    <td><?=base_url();?>api/ddd-service/1</td>
    <td>Retrieve single ddd-service based on primary key</td>
    </tr>
    <tr class="row-odd"><td>GET</td>
    <td><?=base_url();?>api/ddd-service/search/search keyword</td>
    <td>Search for ddd-service with keyword 'search keyword’</td>
    </tr>
    <tr class="row-odd"><td>POST</td>
    <td><?=base_url();?>api/ddd-service</td>
    <td>Add or post new ddd-service</td>
    </tr>
    <tr class="row-even"><td>PUT</td>
    <td><?=base_url();?>api/ddd-service/update/1</td>
    <td>Update ddd-service data</td>
    </tr>
    <tr class="row-odd"><td>DELETE</td>
    <td><?=base_url();?>api/ddd-service/delete/1</td>
    <td>Delete ddd-service data based on primary key</td>
    </tr>
    </tbody>
    </table>
    </div>
...
<section id='list_user'>
  <h2 class='page-header'><a href="#list_user">GET /api/ddd-service</a></h2>
  <p class='lead'>
    Return all ddd-service data. By default Json response will show 10 data per page, but you can add 'perpage' parameter on url to show less or more than 10 data. and alswo to show the next 10 records, you can add 'page' parameter on url<br>
  </p>
<h3>Resource URL</h3>
<h4><?=base_url();?>api/ddd-service</h4>
Go to page 3 by adding 'page' parameter  
<h4><?=base_url();?>api/ddd-service?page=3</h4>
Go to page 3 and show 15 data with 'perpage' parameter
<h4><?=base_url();?>api/ddd-service?page=3&perpage=15</h4>
...
{  
   ...
   results:[  
        ...
        {
          nip:"7327237237",
          nama_dosen:"Mohamad Wildannudin"
        },
   ],
   paginations:{  
      self:"<?=base_url();?>api/ddd-service?page=1&perpage=3",
      first:"<?=base_url();?>api/ddd-service?page=1&perpage=3",
      prev:"<?=base_url();?>api/ddd-service?page=1&perpage=3",
      next:"<?=base_url();?>api/ddd-service?page=2&perpage=3",
      last:"<?=base_url();?>api/ddd-service?page=172&perpage=3"
   }
}
</pre>
<ul>
...
<section id="detail_user">
  <h2 class="page-header"><a href="#detail_user">GET /api/ddd-service/:id</a></h2>
  <p class="lead">Show Detail Single ddd-service</p>

<h3>Resource URL</h3>
<h4><?=base_url();?>api/ddd-service/:id</h4>
<h3>Example Result</h3>
<h4><?=base_url();?>api/ddd-service/107</h4>
    <pre class="prettyprint">
    {
    status: {
        code: 200,
...
<section id="search">
  <h2 class="page-header"><a href="#search">GET /api/ddd-service/search/:search keyword</a></h2>
  <p class="lead">Returns a collection of relevant ddd-service matching a specified query.</p>

<h3>Resource URL</h3>
<h4><?=base_url();?>api/ddd-service/search/:search keyword</h4>
<h3>Example Result</h3>
<h4><?=base_url();?>api/ddd-service/search/search keyword</h4>
    <pre class="prettyprint">
{
    ...
    paginations: {
        self: "<?=base_url();?>api/ddd-service/search/search keyword?page=1",
        first: "<?=base_url();?>api/ddd-service/search/search keyword?page=1",
        prev: "<?=base_url();?>api/ddd-service/search/search keyword?page=1",
        next: "<?=base_url();?>api/ddd-service/search/search keyword?page=1",
        last: "<?=base_url();?>api/ddd-service/search/search keyword?page=1"
    }
}s
</pre>
Response structure is equal to get ddd-service
</section>
...
<h3>Resource URL</h3>
<h4><?=base_url();?>api/ddd-service/login</h4>
<h3>Parameters</h3>
...
<section id='post_user'>
  <h2 class='page-header'><a href="#post_user">POST /api/ddd-service</a></h2>
  <p class='lead'>
    Create / Post New ddd-service<br>
  </p>
<h3>Resource URL</h3>
<h4><?=base_url();?>api/ddd-service</h4>
<h3>Parameters</h3>
  ...
  <pre class="prettyprint">
{
  "status": {
    "error": false,
    "code": 201,
    "message": "ddd-service created successfully",
    "id": "23"
  }
}
</pre>
...
<section id='update'>
  <h2 class='page-header'><a href="#update">PUT /api/ddd-service/update/:id</a></h2>
  <p class='lead'>
    Use PUT method to Update ddd-service data. The request parameter structure is just like previous the <a href='#post_user'>post data</a> <br>
  </p>
<h3>Resource URL</h3>
<h4><?=base_url();?>api/ddd-service/update/:id</h4>
<h3>Sample URL</h3>
<h4><?=base_url();?>api/ddd-service/update/107</h4>
  ...
  <pre class="prettyprint">
{
  "status": {
    "error": false,
    "code": 200,
    "message": "ddd-service Updated successfully"
  }
}
</pre>
</section>
...
<section id='delete'>
  <h2 class='page-header'><a href="#delete">DELETE /api/ddd-service/delete/:id</a></h2>
  <p class='lead'>
    Delete ddd-service Data <br>
  </p>
<h3>Resource URL</h3>
<h4><?=base_url();?>api/ddd-service/delete/:id</h4>

Add header request with token value if you previously enable the authentication, otherwise just send the request.
<h3>Example Result</h3>
<h4><?=base_url();?>api/ddd-service/delete/107</h4>
  ...
  <pre class="prettyprint">
{
  "status": {
    "error": false,
    "code": 200,
    "message": "ddd-service Deleted successfully"
  }
}
</pre>
</section>
