...
<html>
  <head>
    ...
    <title>Mega-sariah Rest API Documentation</title>
  ...
  <body class="skin-blue fixed" data-spy="scroll" data-target="#scrollspy">
    <div class="wrapper">
      ...
      <header class="main-header">
        <!-- Logo -->
        <a style="font-size: 13px;" href="<?=base_url();?>api/mega-sariah/doc" class="logo"><b>Mega-sariah Restful API</b></a>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar" id="scrollspy">
          ...
          <ul class="nav sidebar-menu">
            ...
            <li><a href="#list_user"><i class='fa fa-circle-o'></i> GET /api/mega-sariah</a></li>
            <li><a href="#detail_user"><i class='fa fa-circle-o'></i> GET /api/mega-sariah/:id</a></li>
            <li><a href="#search"><i class='fa fa-circle-o'></i> GET /api/mega-sariah/search/:search keyword</a></li>
            <li><a href="#token"><i class='fa fa-circle-o'></i> Key Token</a></li>
            <li><a href="#post_user"><i class='fa fa-circle-o'></i> POST /api/mega-sariah</a></li>
            <li><a href="#update"><i class='fa fa-circle-o'></i> PUT /api/mega-sariah/update/:id</a></li>
      ...
      <div class="content-wrapper">
        ...
        <div class="content-header">
          <h1>
            Mega-sariah Rest API Documentation
...
<section id='overview'>
  ...
  <p class='lead'>
    This is auto-generated document for <b>mega-sariah Rest API</b> that you can use to query mega-sariah data, search mega-sariah, update mega-sariah, and delete mega-sariah data.
  </p>
...
<section id="method">
  ...
  <p class="lead"></p>
    ...
    <td><?=base_url();?>api/mega-sariah</td>
    <td>Retrieve all mega-sariah</td>
    </tr>
     <tr class="row-even"><td>GET</td>
    <td><?=base_url();?>api/mega-sariah/1</td>
    <td>Retrieve single mega-sariah based on primary key</td>
    </tr>
    <tr class="row-odd"><td>GET</td>
    <td><?=base_url();?>api/mega-sariah/search/search keyword</td>
    <td>Search for mega-sariah with keyword 'search keyword’</td>
    </tr>
    <tr class="row-odd"><td>POST</td>
    <td><?=base_url();?>api/mega-sariah</td>
    <td>Add or post new mega-sariah</td>
    </tr>
    <tr class="row-even"><td>PUT</td>
    <td><?=base_url();?>api/mega-sariah/update/1</td>
    <td>Update mega-sariah data</td>
    </tr>
    <tr class="row-odd"><td>DELETE</td>
    <td><?=base_url();?>api/mega-sariah/delete/1</td>
    <td>Delete mega-sariah data based on primary key</td>
    </tr>
    </tbody>
    </table>
    </div>
...
<section id='list_user'>
  <h2 class='page-header'><a href="#list_user">GET /api/mega-sariah</a></h2>
  <p class='lead'>
    Return all mega-sariah data. By default Json response will show 10 data per page, but you can add 'perpage' parameter on url to show less or more than 10 data. and alswo to show the next 10 records, you can add 'page' parameter on url<br>
  </p>
<h3>Resource URL</h3>
<h4><?=base_url();?>api/mega-sariah</h4>
Go to page 3 by adding 'page' parameter  
<h4><?=base_url();?>api/mega-sariah?page=3</h4>
Go to page 3 and show 15 data with 'perpage' parameter
<h4><?=base_url();?>api/mega-sariah?page=3&perpage=15</h4>
...
{  
   ...
   results:[  
      ...
      { 
        typeInq:'typeInq data', 
        nim:'nim data', 
        Gelombang:'Gelombang data', 
        FormID:'FormID data', 
        numBill:'numBill data', 
        billAmount:'billAmount data', 
        TahunID:'TahunID data', 
        Nama:'Nama data', 
        ProdiNama:'ProdiNama data', 
        FakultasNama:'FakultasNama data', 
      },
   ],
   paginations:{  
      self:"<?=base_url();?>api/mega-sariah?page=1&perpage=3",
      first:"<?=base_url();?>api/mega-sariah?page=1&perpage=3",
      prev:"<?=base_url();?>api/mega-sariah?page=1&perpage=3",
      next:"<?=base_url();?>api/mega-sariah?page=2&perpage=3",
      last:"<?=base_url();?>api/mega-sariah?page=172&perpage=3"
   }
}
</pre>
<ul>
...
<section id="detail_user">
  <h2 class="page-header"><a href="#detail_user">GET /api/mega-sariah/:id</a></h2>
  <p class="lead">Show Detail Single mega-sariah</p>

<h3>Resource URL</h3>
<h4><?=base_url();?>api/mega-sariah/:id</h4>
<h3>Example Result</h3>
<h4><?=base_url();?>api/mega-sariah/107</h4>
    <pre class="prettyprint">
    {
    status: {
        code: 200,
...
<section id="search">
  <h2 class="page-header"><a href="#search">GET /api/mega-sariah/search/:search keyword</a></h2>
  <p class="lead">Returns a collection of relevant mega-sariah matching a specified query.</p>

<h3>Resource URL</h3>
<h4><?=base_url();?>api/mega-sariah/search/:search keyword</h4>
<h3>Example Result</h3>
<h4><?=base_url();?>api/mega-sariah/search/search keyword</h4>
    <pre class="prettyprint">
{
    ...
    paginations: {
        self: "<?=base_url();?>api/mega-sariah/search/search keyword?page=1",
        first: "<?=base_url();?>api/mega-sariah/search/search keyword?page=1",
        prev: "<?=base_url();?>api/mega-sariah/search/search keyword?page=1",
        next: "<?=base_url();?>api/mega-sariah/search/search keyword?page=1",
        last: "<?=base_url();?>api/mega-sariah/search/search keyword?page=1"
    }
}s
</pre>
Response structure is equal to get mega-sariah
</section>
...
<h3>Resource URL</h3>
<h4><?=base_url();?>api/mega-sariah/login</h4>
<h3>Parameters</h3>
...
<section id='post_user'>
  <h2 class='page-header'><a href="#post_user">POST /api/mega-sariah</a></h2>
  <p class='lead'>
    Create / Post New mega-sariah<br>
  </p>
<h3>Resource URL</h3>
<h4><?=base_url();?>api/mega-sariah</h4>
<h3>Parameters</h3>
...
<table border="1" class="table table-bordered">
    ...
    <td>nim</td>
    <td>notEmpty</td>
    <td>Nomor Induk Mahasiswa / Kode Formulir</td>
    </tr>
    <tr class="row-even">
    <td>typeInq</td>
    <td>no</td>
  ...
  <pre class="prettyprint">
{
  "status": {
    "error": false,
    "code": 201,
    "message": "mega-sariah created successfully",
    "id": "23"
  }
}
</pre>
...
<section id='update'>
  <h2 class='page-header'><a href="#update">PUT /api/mega-sariah/update/:id</a></h2>
  <p class='lead'>
    Use PUT method to Update mega-sariah data. The request parameter structure is just like previous the <a href='#post_user'>post data</a> <br>
  </p>
<h3>Resource URL</h3>
<h4><?=base_url();?>api/mega-sariah/update/:id</h4>
<h3>Sample URL</h3>
<h4><?=base_url();?>api/mega-sariah/update/107</h4>
  ...
  <pre class="prettyprint">
{
  "status": {
    "error": false,
    "code": 200,
    "message": "mega-sariah Updated successfully"
  }
}
</pre>
</section>
...
<section id='delete'>
  <h2 class='page-header'><a href="#delete">DELETE /api/mega-sariah/delete/:id</a></h2>
  <p class='lead'>
    Delete mega-sariah Data <br>
  </p>
<h3>Resource URL</h3>
<h4><?=base_url();?>api/mega-sariah/delete/:id</h4>

Add header request with token value if you previously enable the authentication, otherwise just send the request.
<h3>Example Result</h3>
<h4><?=base_url();?>api/mega-sariah/delete/107</h4>
  ...
  <pre class="prettyprint">
{
  "status": {
    "error": false,
    "code": 200,
    "message": "mega-sariah Deleted successfully"
  }
}
</pre>
</section>
