...
foreach ($news as $berita) {
     $clean_isi = strip_tags($berita->isi); // Remove HTML tags
    ?>
      <li>
            <b>
...
if (strlen($berita->isi)<=100) {
    ...
    echo substr($clean_isi , 0, strpos($clean_isi, ' ', 100));
}
      ...
      <div class="modal-footer">
        ...
        <!-- BEGIN FOOTER -->
         <div class="page-footer">
            <div class="page-footer-inner"> <?=date('Y');?> &copy; TIPD IAIN Kerinci.
            </div>
        ...
        <script type="text/javascript">  
             function login_survey_mhs(){  
                 ...
                 document.location="https://survei.iainkerinci.ac.id/inc/login_siakad.php?username="+username+"&password="+encodedPassword+"&login_as=mhs";  
                // alert(username);
              //   var data_login = {
              //           username : username,
              //           password : password,
