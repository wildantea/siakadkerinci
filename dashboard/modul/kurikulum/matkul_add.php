      ...
      <div class="col-lg-12">
        <div class="box box-solid box-primary">
          ...
          <div class="form-group">
              ...
              <div class="form-group">
                <label for="SKS Tatap Muka" class="control-label col-lg-2">Total SKS</label>
                <div class="col-lg-1">
                  <input type="text" name="total_sks" class="form-control" readonly="">
                </div>
                <div class="col-lg-9" style="padding-left:0;padding-top: 5px;font-style: italic;color:#999999">( sks Tatap Muka + sks Praktikum + sks Praktek Lapangan + sks Simulasi )</div>
              </div><!-- /.form-group -->
