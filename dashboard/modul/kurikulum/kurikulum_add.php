    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="alert alert-danger" style="display:none;">
          ...
          ! Kurikulum Pada Periode Akademik Ini Sudah Ada
        </div>
            <form id="input_kurikulum" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/kurikulum/kurikulum_action.php?act=in">
                      <div class="form-group">
                        <label for="Jurusan" class="control-label col-lg-2">Program Studi</label>
                        <div class="col-lg-10">
            <select name="kode_jur" data-placeholder="Pilih Jurusan ..." class="form-control chzn-select" tabindex="2" required>
               <?php       $data = $db->query("select jurusan.kode_jur,jurusan.nama_jur,jenjang_pendidikan.jenjang from jurusan inner join jenjang_pendidikan
...
order by tahun desc") as $isi) {
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="nama_kurikulum" placeholder="Nama Kurikulum" class="form-control" required>
                </div>
              </div><!-- /.form-group -->
              ...
              <div class="col-lg-10">
                <input type="text" name="no_sk_rektor" placeholder="No SK Rektor" class="form-control" >
              </div>
            </div>
            ...
            <div class="col-lg-10">
              <input type="text" id="tgl1" data-rule-date="true" name="tgl_sk_rektor" placeholder="Tanggal SK Rektor" class="form-control" >
            </div>
                      </div>
                   <!--   
            <div class="form-group">
              ...
              <div class="col-lg-10">
                <input type="text" name="tgl_disetujui" placeholder="Tanggal Disetujui" class="form-control" >
              </div>
            </div>/.form-group
            ...
            <div class="form-group">
              ...
              <div class="col-lg-10">
                <input type="text" name="yang_menyetujui" placeholder="Yang Menyetujui" class="form-control" >
              </div>
            </div>/.form-group
            ...
            <div class="form-group">
              ...
              <div class="col-lg-10">
                <input type="text" name="no_sk_dikti" placeholder="No SK Dikti" class="form-control" >
              </div>
            </div>/.form-group
            ...
            <div class="col-lg-10">
              <input type="text" id="tgl2" data-rule-date="true" name="tgl_sk_dikti" placeholder="Tanggal SK DIKTI" class="form-control" >
            </div>
                      </div>/.form-group
            ...
            <div class="form-group">
              ...
              <div class="col-lg-10">
                <input type="text" name="masa_studi_ideal" placeholder="Masa Studi Ideal" class="form-control" >
              </div>
            </div>/.form-group
            ...
            <div class="form-group">
              ...
              <div class="col-lg-10">
                <input type="text" name="masa_studi_max" placeholder="Masa Studi Max" class="form-control" >
              </div>
            </div>/.form-group
            ...
            <div class="form-group">
              ...
              <div class="col-lg-10">
                <input type="text" name="gelar_dipakai" placeholder="Gelar Dipakai" class="form-control" >
              </div>
            </div>/.form-group -->
          ...
          <div class="form-group">
              ...
              <div class="col-lg-3">
                <input type="text" onkeypress="return isNumberKey(event)" data-rule-number="true" name="jml_sks_wajib" placeholder="Jml SKS Wajib" class="form-control" >
              </div>
          </div><!-- /.form-group -->
          ...
          <div class="form-group">
              ...
              <div class="col-lg-3">
                <input type="text" onkeypress="return isNumberKey(event)" data-rule-number="true" name="jml_sks_pilihan" placeholder="Jml SKS Pilihan" class="form-control" >
              </div>
          </div><!-- /.form-group -->
          ...
          <div class="form-group">
              ...
              <div class="col-lg-3">
                <input type="text" onkeypress="return isNumberKey(event)" name="total_sks" placeholder="( sks Wajib + sks Pilihan )" class="form-control" readonly="" >
              </div>
          </div><!-- /.form-group -->
    ...
    $("#input_kurikulum").validate({
        ...
        submitHandler: function(form) {
            ...
            $(form).ajaxSubmit({
                ...
                data: $("#input_kurikulum").serialize(),
