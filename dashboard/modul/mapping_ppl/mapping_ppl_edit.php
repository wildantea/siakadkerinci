<!-- Content Header (Page header) -->
              <section class="content-header">
                  <h1>Mapping PPL</h1>
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Edit Mapping PPL</li>
                    </ol>
              </section>
                  ...
                  <div class="col-lg-12">
                      <div class="box box-solid box-primary">
                          <div class="box-header">
                              <h3 class="box-title">Edit Mapping PPL</h3>
                      ...
                      <div class="box-body">
                       <div class="alert alert-danger error_data" style="display:none">
                        ...
                        <span class="isi_warning"></span>
                          ...
                          <form id="edit_mapping_ppl" method="post" class="form-horizontal" action="<?=base_admin();?>modul/mapping_ppl/mapping_ppl_action.php?act=up">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <select id="kode_mk" name="kode_mk" data-placeholder="Pilih kode_mk..." class="form-control chzn-select" tabindex="2" >
                      <option value=""></option>
                     <?php
                     $option = array(
'1' => 'Test',
                     ...
                     foreach ($option as $isi => $val) {
                        ...
                        if ($data_edit->kode_mk==$isi) {
                          echo "<option value='$data_edit->kode_mk' selected>$val</option>";
                        } else {
