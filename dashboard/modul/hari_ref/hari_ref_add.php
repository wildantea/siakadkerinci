<!-- Content Header (Page header) -->
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Add Hari Ref</li>
        </ol>
    </section>
      ...
      <div class="col-lg-12">
        <div class="box box-solid box-primary">
          <div class="box-header">
            <h3 class="box-title">Add Hari Ref</h3>
          ...
          <div class="box-body">
            <form id="input_hari_ref" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/hari_ref/hari_ref_action.php?act=in">
