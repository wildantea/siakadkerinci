<!-- Content Header (Page header) -->
                <section class="content-header">
                   ...
                   <ol class="breadcrumb">
                        ...
                        <li><a href="<?=base_index();?>identitas">Identitas</a></li>
                        <li class="active">Detail Identitas</li>
                    </ol>
                </section>
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" disabled="" value="<?=$data_edit->id_identitas;?>" class="form-control">
                </div>
              </div><!-- /.form-group -->
          ...
          <div class="form-group">
              ...
              <div class="col-lg-10">
                <textarea id="editbox" name="isi" disabled="" class="editbox"required><?=$data_edit->isi;?> </textarea>
                      ...
                      <a href="<?=base_index();?>identitas" class="btn btn-success "><i class="fa fa-step-backward"></i> <?php echo $lang["back_button"];?></a>
