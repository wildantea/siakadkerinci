...
$columns = array(
  ...
  $query = $datatable2->execQuery("select view_simple_mhs_data.nim,view_simple_mhs_data.nama,view_simple_mhs_data.angkatan,view_simple_mhs_data.jurusan,krs_detail.id_krs_detail from krs_detail inner join view_simple_mhs_data on krs_detail.nim=view_simple_mhs_data.nim where id_kelas='$id_kelas' and disetujui='0'",$columns);
