...
<!-- Content Header (Page header) -->
 ...
 <div class="alert alert-danger error_data" style="display:none">
          ...
          <span class="isi_warning"></span>
            ...
            <form id="input_kelas" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/kelas_jadwal/kelas_jadwal_action.php?act=up">   

            <div class="form-group">
                <label for="Kode Paralel" class="control-label col-lg-2">Program Studi</label>
                <div class="col-lg-6">
                  <input type="text" class="form-control" value="<?=$data_edit->jurusan;?>" readonly>
                  </select>
                </div>
            </div>
            <div class="form-group">
                        ...
                        <div class="col-lg-6">
                        <?php 
                        $semester = $db->fetch_single_row("view_semester","id_semester",$data_edit->sem_id);
                        ?>
                  <input type="text" class="form-control" value="<?=$semester->tahun_akademik;?>" readonly>
          <input type="hidden" name="sem_id" value="<?= $data_edit->sem_id ?>"> 
            ...
            <div class="form-group">
                        ...
                        <div class="col-lg-6">
                        <?php 
                        $semester = $db->fetch_single_row("view_semester","id_semester",$data_edit->semester_kurikulum);
                        ?>
                  <input type="text" class="form-control" value="<?=$data_edit->nama_kurikulum.'-'.$semester->tahun_akademik;?>" readonly>
          </div>
                      </div><!-- /.form-group -->
            <div class="form-group">
              ...
              <div class="col-lg-6">
                   ...
                   <input type="text" class="form-control" value="<?=$data_edit->nm_matkul;?> - Semester <?=$data_edit->sem_matkul;?>" readonly>
              </div>
            </div>
             <div class="form-group">
    ...
    <div class="col-lg-3">
      <select id="id_jenis_kelas" name="id_jenis_kelas" required data-placeholder="Pilih Jenis Kelas ..." class="form-control chzn-select" tabindex="2" >
       ...
       <?php
         ...
         foreach ($kl as $kls) {
           if ($data_edit->id_jenis_kelas==$kls->id) {
             echo "<option value='$kls->id' selected>$kls->nama_jenis_kelas</option>";
           } else {
       ...
       ?>
          ...
          <div class="form-group">
              ...
              <div class="col-lg-2">
                <input type="text" id="kls_nama" maxlength="5" name="kls_nama" value="<?=$data_edit->nama_kelas;?>" class="form-control" required >
              </div>
          </div>
          ...
          <div class="form-group">
              ...
              <div class="col-lg-2">
                <input type="text" onkeypress="return isNumberKey(event)" required name="peserta_max" value="<?=$data_edit->peserta_max;?>" class="form-control" >
              </div>
          </div>
          ...
          <div class="form-group">
              ...
              <div class="col-lg-2">
                <input type="text" onkeypress="return isNumberKey(event)" required name="peserta_min" value="<?=$data_edit->peserta_min;?>" class="form-control" >
              </div>
          </div>
...
/*              foreach ($db->query("select k.*,kp.id as id_kls_komponen,kp.id_kelas,kp.id_komponen,kp.nilai
                                   ...
                                   where kp.id_kelas='$data_edit->kelas_id' ") as $k) {
               ?>
          ...
          <div class="form-group">
              ...
              <div class="col-lg-10">
                <textarea class="form-control col-xs-12" rows="5" value="<?=$data_edit->catatan;?>" name="catatan" ></textarea>
              </div>
          </div>
          <input type="hidden" name="kelas_id" value="<?=$data_edit->kelas_id;?>">
