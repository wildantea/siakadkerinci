...
?>
      <form method="GET" id="form_jadwal_gen" class="form-horizontal foto_banyak" action="<?=base_admin();?>index.php/kelas-jadwal/generate-jadwal">
                        ...
                        <div class="col-lg-9">
                                ...
                                $jurusan = $db->query("select * from view_prodi_jenjang $akses_prodi");
                                    ...
                                    foreach ($jurusan as $dt) {
                                      echo "<option value='".$enc->enc($dt->kode_jur)."' selected>$dt->jurusan</option>";
                                    }
                                  } else {
                                    echo "<option value=''>Pilih Program Studi</option>";
                                    foreach ($jurusan as $dt) {
                                     echo "<option value='".$enc->enc($dt->kode_jur)."'>$dt->jurusan</option>";
                                    }
                                  }
                                ?>
                                        </select>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            ...
                            foreach ($db->fetch_all("view_semester") as $isi) {
                                if ($isi->aktif==1) {
                                    echo "<option value='".$enc->enc($isi->id_semester)."' selected>$isi->tahun_akademik</option>";
                                    $aktif = $isi->tahun_akademik;
                                } else {
                                    echo "<option value='".$enc->enc($isi->id_semester)."'>$isi->tahun_akademik</option>";
                                }
              ...
              <div class="form-group">
                <div class="col-lg-12">
                  ...
                  <button type="submit" class="btn btn-primary"><i class="fa fa-gear"></i> Generate</button>
