  ...
  if ($i==1) {
    ...
    $ada_header=true;
               ...
               <tr>
                 ...
                 <td nowrap ="nowrap"  valign="top"><ol style="padding:0 0 0 15;">
                   ...
                   $qd = $db->query("select d.nip,d.gelar_depan,d.`nama_dosen`,d.gelar_belakang,dk.`dosen_ke` from dosen_kelas dk 
                    join dosen d on dk.`id_dosen`=d.nip where dk.`id_kelas`='".$_POST['kelas_id']."'");
                   foreach ($qd as $kd) {
         ...
         if ($last_page) {
           ?>
           <tr>
            <th colspan="19">DOSEN PENGAMPU</th>
          </tr>
          <?php
          $qd = $db->query("select d.nip,d.gelar_depan,d.`nama_dosen`,d.gelar_belakang,dk.`dosen_ke` from dosen_kelas dk 
            join dosen d on dk.`id_dosen`=d.nip where dk.`id_kelas`='".$_POST['kelas_id']."'");
          foreach ($qd as $kd) {
           ?>
           <tr>
             <td nowrap ="nowrap" height="34" style="text-align:center; vertical-align:middle;width: 25px"><?= $kd->dosen_ke ?></td> 
             <td nowrap ="nowrap" style="text-align:center; vertical-align:middle;width: 100px"><?= $kd->nip ?></td>
             <td style="vertical-align:middle;width: 220px"><div class="nama"><?= $kd->gelar_depan." ".$kd->nama_dosen.",".$kd->gelar_belakang ?> </div></td>
             <td nowrap ="nowrap" >&nbsp;</td>
             <td nowrap ="nowrap" >&nbsp;</td> 
             <td nowrap ="nowrap" >&nbsp;</td>
             <td nowrap ="nowrap" >&nbsp;</td>
      ...
      <table align="right" width="100%">
        <tr>
         ...
         <br><td align="center">Sungai Penuh, <?php echo tgl_indo(date("Y-m-d"));?><br /><span id="tipe_pengesahan0">...............</span><br /><span id="jabatan0"></span></td>
       </tr>
       <tr>
         <td align="center" height="50"></td>
       </tr>
       <tr>
         <td align="center" nowrap="nowrap"><span id="nama0"><?= $kel->gelar_depan ?> <?= $kel->nama_dosen ?> <?= $kel->gelar_belakang ?></span>
