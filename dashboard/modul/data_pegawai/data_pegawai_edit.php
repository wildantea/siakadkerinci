...
$data_edit = $db->fetch_single_row("pegawai","id",$_POST['id_data']);
?>
          ...
          <span class="isi_warning"></span>
            ...
            <form id="edit_data_pegawai" method="post" class="form-horizontal" action="<?=base_admin();?>modul/data_pegawai/data_pegawai_action.php?act=up">
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="nama_pegawai" value="<?=$data_edit->nama_pegawai;?>" class="form-control" required>
                </div>
              </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="gelar_depan" value="<?=$data_edit->gelar_depan;?>" class="form-control" >
                </div>
              </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="gelar_belakang" value="<?=$data_edit->gelar_belakang;?>" class="form-control" >
                </div>
              </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="radio radio-success radio-inline">
                  <input type="radio" name="jk"  id="radio1" value="Laki-laki" <?=($data_edit->jk=="Laki-laki")?"checked":"";?> required>
                ...
                <div class="radio radio-success radio-inline">
                  <input type="radio" name="jk"  id="radio2" value="Perempuan" <?=($data_edit->jk=="Perempuan")?"checked":"";?> required>
