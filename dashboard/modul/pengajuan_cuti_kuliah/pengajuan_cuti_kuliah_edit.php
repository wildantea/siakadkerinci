  ...
  <style type="text/css"> .datepicker {z-index: 1200 !important; } </style>
   <div class="alert alert-danger error_data" style="display:none">
          ...
          <span class="isi_warning"></span>
            ...
            <form id="input_pengajuan_cuti_kuliah" method="post" class="form-horizontal" action="<?=base_admin();?>modul/pengajuan_cuti_kuliah/pengajuan_cuti_kuliah_action.php?act=up">
          ...
          <div class="form-group">
              ...
              <div class="col-lg-10">
                <textarea class="form-control col-xs-12" rows="5" name="alasan_cuti" ><?=$data_edit->alasan_cuti;?></textarea>
              </div>
          </div><!-- /.form-group -->
