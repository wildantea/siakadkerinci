...
<!-- Content Header (Page header) -->
                <section class="content-header">
                    <h1>
                        Manage Cetak Kartu Kolektif
                    </h1>
                        <ol class="breadcrumb">
                        <li><a href="<?=base_index();?>"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li><a href="<?=base_index();?>cetak-kartu-kolektif">Cetak Kartu Kolektif</a></li>
                        <li class="active">Cetak Kartu Kolektif List</li>
                    </ol>
                </section>
  ...
  <div class="row">
    <div class="col-xs-12">
      <div class="box">
         ...
         <div class="row">
           <div class="col-md-6">
              <h3 class="text-center">Form Filter Cetak Kartu Kolektif</h3>
           </div>
         </div>
