    ...
    <div class="col-xs-12">
      <div class="box">
         <div class="box-body">
                    ...
                    <form action="<?= base_admin().'modul/rekap_input_nilai/' ?>sudah_input_cetak.php" method="post">
                     ...
                     <br>
                        ...
                        <table id="dtb_manual" class="table table-bordered table-striped">
                            ...
                            <tbody>
                              ...
                              $no=1;
                                  ...
                                  $qq = $db->query("SELECT matkul.kode_mk, d.`gelar_depan`, d.`nama_dosen`, d.`gelar_belakang`, j.nama_jur, kelas.`sem_id`, kelas.kls_nama,kelas.kode_paralel, kelas.peserta_max,kelas.peserta_min,matkul.nama_mk, kelas.kelas_id,  
                                                      ...
                                                      where j.kode_jur='".$dec->dec(uri_segment(3))."' and kelas.sem_id='".$dec->dec(uri_segment(4))."' and (SELECT COUNT(id_krs_detail) FROM krs_detail k WHERE k.id_kelas=kelas.kelas_id AND (nilai_huruf='')
                            ...
                            <input type='hidden' name='jur' value='<?= de(uri_segment(3)) ?>' method="post">
