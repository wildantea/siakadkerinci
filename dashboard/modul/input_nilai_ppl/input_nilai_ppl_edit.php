<!-- Content Header (Page header) -->
              <section class="content-header">
                  <h1>Input Nilai PPL</h1>
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Edit Input Nilai PPL</li>
                    </ol>
              </section>
                  ...
                  <div class="col-lg-12">
                      <div class="box box-solid box-primary">
                          <div class="box-header">
                              <h3 class="box-title">Edit Input Nilai PPL</h3>
                      ...
                      <div class="box-body">
                       <div class="alert alert-danger error_data" style="display:none">
                        ...
                        <span class="isi_warning"></span>
                          ...
                          <form id="edit_input_nilai_ppl" method="post" class="form-horizontal" action="<?=base_admin();?>modul/input_nilai_ppl/input_nilai_ppl_action.php?act=up">
                            
              <div class="form-group">
                <label for="tgl_awal_input_nilai" class="control-label col-lg-2">tgl_awal_input_nilai </label>
                <div class="col-lg-10">
                  <input type="text" name="tgl_awal_input_nilai" value="<?=$data_edit->tgl_awal_input_nilai;?>" class="form-control" >
                </div>
              </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="tgl_akhir_input_nilai" value="<?=$data_edit->tgl_akhir_input_nilai;?>" class="form-control" >
                </div>
              </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="id_priode" value="<?=$data_edit->id_priode;?>" class="form-control" >
                </div>
              </div><!-- /.form-group -->
