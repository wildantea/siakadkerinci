...
<?php 
$periode = $db->query("select * from priode_ppl");
...
foreach ($periode as $ak) {
 ...
 <?php
  ...
  <div class="form-group">
                        ...
                        <div class="col-lg-5">
                        <select id="prodi_filter" name="prodi" data-placeholder="Pilih Semester ..." class="form-control chzn-select" tabindex="2">
 <?php
                                looping_prodi();
                                ?>
              </select>
  ...
  <div class="form-group">
                        <label for="Semester" class="control-label col-lg-2">Lokasi</label>
                        <div class="col-lg-5">
                        <select id="lokasi_filter" name="lokasi" data-placeholder="Pilih Lokasi ..." class="form-control chzn-select" tabindex="2">
                              <option value="all">Semua</option>
                            <?php
                            foreach ($db->query("select * from lokasi_ppl where id_periode='$periode_aktif' group by id_lokasi") as $value) {
                               echo "<option value='$value->id_lokasi'>".$value->nama_lokasi."</option>";
                            }
                            ?>
              </select>
