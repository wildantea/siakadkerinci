...
$kode_pembayaran = "";
  ...
  $query = $datatable->get_custom("select keu_tagihan_mahasiswa.briva_no, keu_tagihan_mahasiswa.nim,mahasiswa.nama,vs.tahun_akademik,view_prodi_jenjang.jurusan,
keu_jenis_tagihan.nama_tagihan,keu_tagihan.nominal_tagihan,keu_tagihan_mahasiswa.id from keu_tagihan_mahasiswa
 ...
 inner join view_semester vs on keu_tagihan_mahasiswa.periode=vs.id_semester $kode_prodi $periode $kode_pembayaran $kode_tagihan ",$columns);
