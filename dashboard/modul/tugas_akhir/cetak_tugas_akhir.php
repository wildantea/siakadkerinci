...
<style type="text/css"> .datepicker {z-index: 1200 !important; } </style>
  <form  class="form-horizontal foto_banyak" id="sem" target="__Blank" action="<?=base_admin().'modul/tugas_akhir/cetak_tugasakhir.php'?>" method="post">
    <div class="form-group">
      <label for="Semester" class="control-label col-lg-2">Fakultas <span style="color:#FF0000">*</span></label>
      <div class="col-lg-10">
        <select id="fakultas" name="fakultas_filter" data-placeholder="Pilih Fakultas ..." class="form-control chzn-select" tabindex="2" required>
          <option value=""></option>
           <?php
    ...
    <div class="form-group">
      ...
      <div class="col-lg-10">
        <select id="jurusan" name="jurusan_filter" data-placeholder="Pilih Jurusan ..." class="form-control chzn-select" tabindex="2" required>
          <option value=""></option>        
        </select>
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-lg-10">
        <select id="priode_filter" name="priode_filter" data-placeholder="Pilih Priode Munaqasah ..." class="form-control chzn-select" tabindex="2">
        <option value=""></option>
           <?php
