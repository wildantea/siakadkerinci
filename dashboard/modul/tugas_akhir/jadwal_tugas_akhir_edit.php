...
$data_edit = $db->query("select * from jadwal_muna where id_muna='".$_POST['id_data']."'");
foreach ($data_edit as $de) {
?>
<style type="text/css"> .datepicker {z-index: 1200 !important; } </style>
  <form id="input_tugas_akhir" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/tugas_akhir/tugas_akhir_action.php?act=up_jadwal">
            ...
            <label for="Nama Kelas" class="control-label col-lg-2">Priode</label>
              <div class="col-lg-10">
                <select name="priode_muna" id="priode_muna" data-placeholder="Pilih Semester ..." class="form-control chzn-select" tabindex="2" >
                 ...
                 foreach ($sem as $isi2) {
                  if ($isi2->id_semester==$de->priode_muna) {
          ...
          <div class="form-group">
              ...
              <div class="col-lg-10">
                <input id="tgl3" type="text" name="batas_awal" placeholder="Awal Daftar" class="form-control" value="<?=$de->batas_awal;?>" required>
              </div>
          </div><!-- /.form-group -->
          ...
          <div class="form-group">
              ...
              <div class="col-lg-10">
                <input id="tgl2" type="text" name="batas_akhir" placeholder="Akhir Daftar" class="form-control" value="<?=$de->batas_akhir;?>" required>  
              </div>
          </div><!-- /.form-group -->
          ...
          <div class="form-group">
            ...
            <div class="col-lg-10">
              <input id="tgl1" type="text" name="tanggal_sidang" placeholder="Tanggal Sidang" class="form-control" value="<?=$de->tanggal_sidang;?>" required>
            </div>
          </div><!-- /.form-group -->

          <input type="hidden" name="id" value="<?=$de->id_muna;?>">
        ...
        submitHandler: function(form) {
            ...
            $(form).ajaxSubmit({
                ...
                success: function(data) {
                    $('#modal_tugas_akhir_edit').modal('hide');
                    $("#loadnya").hide();
                    if(data == "good") {
