...
<section class="content">
 ...
 <a href="<?=base_index();?>nilai" class="btn btn-default" id="btn-simpan"><i class="fa fa-backward"></i> Kembali</a>
 <br><br>
...
?>
             <span type="submit" class="btn btn-success tambah-komponen" data-toggle="tooltip" data-id="<?=$id_kelas;?>" data-title="<?=$button_komponen;?> Komponen Penilaian"><i class="fa <?=$fa_komponen;?>"></i> <?=$button_komponen;?></span> 
             </th>
           </tr>
<?php 
$prosentase = 0;
...
<!--               
        ...
        <table  class="table table-bordered table-striped">
         ...
         <?php
              ...
              $nilai_data = $db->query("select id_krs_detail,
                    CASE 
        WHEN 
            krs_detail.komponen_nilai REGEXP '\"id\":\"2\",\"nilai\":\"0\"'
            AND krs_detail.komponen_nilai REGEXP '\"id\":\"3\",\"nilai\":\"0\"'
            AND krs_detail.komponen_nilai REGEXP '\"id\":\"4\",\"nilai\":\"0\"'
            AND krs_detail.komponen_nilai REGEXP '\"id\":\"5\",\"nilai\":\"0\"'
            AND krs_detail.komponen_nilai REGEXP '\"id\":\"6\",\"nilai\":\"0\"'
        THEN 1
        ELSE 0
    END AS belum_dinilai,
    nilai_angka,nilai_huruf,bobot,krs_detail.nim,nama,left(mulai_smt,4) as angkatan,mulai_smt from krs_detail inner join mahasiswa using(nim) where id_kelas=? and disetujui='1' order by nama asc",array('id_kelas' => $id_kelas));
              ...
              foreach ($nilai_data as $nilai) {
                ...
                <tr class="row-data" style="background: <?=$bg_color?>">
                  <td style="background: #fff;text-align: center;vertical-align: middle"><label class="mt-checkbox mt-checkbox-single mt-checkbox-outline"> <input type="checkbox" class="group-checkable check-selected"  data-id="<?=$nilai->id_krs_detail;?>"> <span></span></label><?=$no;?></td>
...
<div class="modal fade" id="modal_komponen_penilaian" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"> <div class="modal-dialog modal-lg"> <div class="modal-content"><div class="modal-header"> <button type="button" class="close" data-dismiss="modal" aria-label="Close">
...
<div class="modal" id="modal_edit_nilai" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"> <div class="modal-dialog modal-lg modal-edit-nilai"> <div class="modal-content modal-content-nilai"><div class="modal-header"><button type="button" data-toggle="tooltip" data-placement="bottom" data-title="Tutup" class="close" data-dismiss="modal" aria-label="Close">
    <span aria-hidden="true"><i class="fa fa-times"></i></span>
</button>
...
$(".edit-nilai").click(function(event) {
        ...
        $.ajax({
            url : "<?=base_admin();?>modul/nilai_per_kelas/edit_nilai_with_komponen_dosen.php",
            type : "post",
