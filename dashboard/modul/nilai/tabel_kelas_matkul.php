                              ...
                              foreach ($qq as $k) {
                               ...
                               ?>
                                  ...
                                  <td>
                                    <?php 
                                     if ($_SESSION['level']=='1') {
                                       echo '<a href="'.base_index().'nilai/add_nilai/'.en($k->kelas_id)."/".$_GET['jur'].'/'.$_GET['sem'].'" data-id="'.$k->kelas_id.'" class="btn edit_data btn-primary "><i class="fa fa-pencil"></i> Input Nilai</a> '; 
                                     }
                                     else if ($_SESSION['level']=='4') {
                                  
                                         echo '<a href="'.base_index().'nilai/add_nilai/'.en($k->kelas_id)."/".$_GET['sem'].'" data-id="'.$k->kelas_id.'" class="btn edit_data btn-primary "><i class="fa fa-pencil"></i> Input Nilai</a> '; 
                                     }
