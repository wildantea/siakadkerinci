<!-- Content Header (Page header) -->
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Add Nilai Ref</li>
        </ol>
    </section>
      ...
      <div class="col-lg-12">
        <div class="box box-solid box-primary">
          <div class="box-header">
            <h3 class="box-title">Add Nilai Ref</h3>
          ...
          <div class="box-body">
            <form id="input_nilai_ref" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/nilai_ref/nilai_ref_action.php?act=in">
                      
              <div class="form-group">
                <label for="Bobot" class="control-label col-lg-2">Bobot </label>
                <div class="col-lg-10">
                  <input type="text" name="bobot" placeholder="Bobot" class="form-control" >
                </div>
              </div><!-- /.form-group -->
          ...
          <div class="form-group">
              ...
              <div class="col-lg-10">
                <input type="text" data-rule-number="true" name="batas_bawah" placeholder="Batas Bawah" class="form-control" >
              </div>
          </div><!-- /.form-group -->
          ...
          <div class="form-group">
              ...
              <div class="col-lg-10">
                <input type="text" data-rule-number="true" name="batas_atas" placeholder="Batas Atas" class="form-control" >
              </div>
          </div><!-- /.form-group -->
          <div class="form-group">
          ...
          <div class="form-group">
              ...
              <div class="col-lg-10">
                <input type="text" id="tgl1" data-rule-date="true" name="tgl_mulai" placeholder="Tanggal Mulai Efektif" class="form-control" >
              </div>
          </div><!-- /.form-group -->
          ...
          <div class="form-group">
              ...
              <div class="col-lg-10">
                <input type="text" id="tgl2" data-rule-date="true" name="tgl_selesai" placeholder="Tanggal Selesai Efektif" class="form-control" >
              </div>
          </div><!-- /.form-group -->
    ...
    $("#input_nilai_ref").validate({
        ...
        submitHandler: function(form) {
            ...
            $(form).ajaxSubmit({
                ...
                data: $("#input_nilai_ref").serialize(),
