...
<style type="text/css"> .datepicker {z-index: 1200 !important; } </style>
 <div class="alert alert-danger error_data" style="display:none">
      ...
      <form id="input_jam_sesi_kuliah" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/jam_sesi_kuliah/jam_sesi_kuliah_action.php?act=in">
                      
          <div class="form-group">
              <label for="Sesi" class="control-label col-lg-2">Sesi <span style="color:#FF0000">*</span></label>
              <div class="col-lg-10">
                <input type="text" data-rule-number="true" name="sesi" placeholder="Sesi" class="form-control" required>
              </div>
          </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="jam_mulai" placeholder="Jam Mulai" class="form-control" required>
                </div>
              </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="jam_selesai" placeholder="Jam Selesai" class="form-control" required>
                </div>
              </div><!-- /.form-group -->
...
<script type="text/javascript">
    ...
    $("#input_jam_sesi_kuliah").validate({
