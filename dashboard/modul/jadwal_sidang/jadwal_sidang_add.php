...
<table id="tabelku" class="table table-bordered table-striped" cellspacing="0" width="100%">
 ...
 <div class="alert alert-danger error_data" style="display:none">
      ...
      <form id="input_jadwal_sidang" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/jadwal_sidang/jadwal_sidang_action.php?act=in">
          ...
          <!--       <div class="form-group">
                        ...
                        <div class="input-group clockpicker" data-placement="bottom" data-align="top" data-autoclose="true">
                            <input type="text" class="form-control waktu"  name="jam_mulai" autocomplete="off"  required="">
                            <span class="input-group-addon">
                        ...
                        S/d
                                  ...
                                  <div class="col-lg-3">
                        <div class="input-group clockpicker" data-placement="bottom" data-align="top" data-autoclose="true">
                            <input type="text" autocomplete="off" class="form-control waktu" name="jam_selesai" required="">
                            <span class="input-group-addon">
                                <span class="glyphicon glyphicon-time"></span>
                            </span>
                        </div>
...
?>
  ...
  <div class="form-group show-ruangan" style="display: none">
...
<!--             <div class="form-group" style="margin-bottom: 0">
                        <label for="Mata Kuliah Setara" class="control-label col-lg-2">Dosen Penguji</label>
                        <div class="col-lg-10">
              <a class="btn btn-success " style="cursor:pointer" id="add_dosen"><i class="fa fa-plus"></i> Tambah Dosen Penguji</a>
              <table class="table" style="margin-bottom: 0">
                ...
                <tfoot><td>&nbsp;</td><td>&nbsp;</td><td colspan="2"><span class="error-dosen"></span></td></tfoot>
              </table>
            </div>
          </div> -->
              <div class="form-group">
