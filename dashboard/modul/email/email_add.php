<!-- Content Header (Page header) -->
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><?php echo $lang["add_button"];?> Email</li>
        </ol>
    </section>
      ...
      <div class="col-lg-12">
        <div class="box box-solid box-primary">
          <div class="box-header">
            <h3 class="box-title"><?php echo $lang["add_button"];?> Email</h3>
          ...
          <span class="isi_warning"></span>
            ...
            <form id="input_email" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/email/email_action.php?act=in">
          ...
          <div class="form-group">
              ...
              <div class="col-lg-10">
                <input name="login" data-on-text="Yes" data-off-text="No" class="make-switch" type="checkbox" checked>
              </div>
          </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="client_id" placeholder="client_id" class="form-control" required>
                </div>
              </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="client_secret" placeholder="client_secret" class="form-control" required>
                </div>
              </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="redirect_url" placeholder="redirect_url" class="form-control" required>
                </div>
              </div><!-- /.form-group -->
            <div class="form-group">
