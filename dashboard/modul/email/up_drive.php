      ...
      <div class="col-lg-12">
        <div class="box box-solid box-primary">
          ...
          <span class="isi_warning"></span>
            ...
            <form id="input_upload_drive" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/email/up_drive_action.php">
                      
              <div class="form-group">
                <label for="nama" class="control-label col-lg-2">DIR Name <span style="color:#FF0000">*</span></label>
                <div class="col-lg-10">
                  <input type="text" name="nama" value="ucing" class="form-control" required>
                </div>
              </div><!-- /.form-group -->
              <div class="form-group">
              ...
              <div class="fileinput fileinput-new" data-provides="fileinput">
                            <div class="input-group">
                              ...
                              <span class="input-group-addon btn btn-default btn-file"><span class="fileinput-new">Select file</span> <span class="fileinput-exists">Change</span>
                                <input type="file" name="fileToUpload" required class="file-upload-data">
                              </span>
