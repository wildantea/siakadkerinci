...
<div class="box box-primary">
          ...
          <div class="form-group">
                                <label for="Semester" class="control-label col-lg-2">Program Studi Kelas</label>
                                <div class="col-lg-5">
 ...
 <div class="alert alert-warning fade in error_data_delete" style="display:none">
          ...
          <i class="icon fa fa-warning"></i> <span class="isi_warning_delete"></span>
            ...
            <thead>
              <tr>
                <th class='center' valign="center">No</th>
                <th class='center' valign="center">NIP</th>
                <th class='center' valign="center">Nama Dosen</th>
                <th class='center' valign="center">Jumlah Kelas</th>
                <th class='center' valign="center">SKS S1</th>
                <th class='center' valign="center">SKS S2</th>
                <th class='center' valign="center">Total SKS</th>
              </tr>
            </thead>
                            <tbody>
                            </tbody>
...
$("#jur_filter").change(function(){
  ...
  dataTable_jadwal = $("#dtb_kelas_jadwal").DataTable({
           ...
           'columnDefs': [ {
            ...
            'ajax':{
              url :'<?=base_admin();?>modul/rekap_dosen_jml_kelas/rekap_dosen_jml_kelas_data.php',
