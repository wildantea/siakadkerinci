...
$data_edit = $db->fetch_single_row("keu_tagihan","id",$_POST['id_data']);
$jur = $db->fetch_single_row("view_prodi_jenjang","kode_jur",$data_edit->kode_prodi);
?>
  <style type="text/css"> .datepicker {z-index: 1200 !important; } .chosen-container-multi .chosen-choices {
   ...
   <div class="alert alert-danger error_data" style="display:none">
          ...
          <span class="isi_warning"></span>
            ...
            <form id="edit_setting_tagihan_prodi" method="post" class="form-horizontal" action="<?=base_admin();?>modul/setting_tagihan_prodi/setting_tagihan_prodi_action.php?act=up">
                            <div class="form-group">
             <label for="Program Studi" class="control-label col-lg-2">Program Studi <span style="color:#FF0000">*</span></label>
             <input type="hidden" name="kode_prodi" value="<?=$data_edit->kode_prodi;?>">
                        <div class="col-lg-10">
              <input type="text" class="form-control" value="<?=$jur->jurusan;?>" readonly>
          </div>
                      </div><!-- /.form-group -->
              <div class="form-group">
...
<div class="input-group">
            ...
            <input id="auto" type="text" name="nominal_tagihan" value="<?=$data_edit->nominal_tagihan;?>" class="form-control" data-a-sep="." data-a-dec="," required="">
          </div>
...
<script type="text/javascript">
    ...
    $("#edit_setting_tagihan_prodi").validate({
