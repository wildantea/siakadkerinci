...
<body onLoad="//window.print();">
  ...
  <div class="page-break">
   ...
   <h2 align="center">DAFTAR REKAPITULASI PESERTA KELAS</h2>
...
<?php
          ...
          $q=$db->query("SELECT m.`nim`, m.`nama`,j.`nama_jur`, a.`jatah_sks`, a.ipk, a.`sem_id`, m.`mulai_smt`,a.akm_id FROM akm a 
                                                    JOIN mahasiswa m ON m.`nim` = a.`mhs_nim`
                                                    JOIN jurusan j ON j.kode_jur=m.`jur_kode` 
