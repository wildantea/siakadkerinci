...
<!-- Content Header (Page header) -->
                <section class="content-header">
                    <h1>
                        Manage Rekap Hasil Studi
                    </h1>
                        <ol class="breadcrumb">
                        <li><a href="<?=base_index();?>"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li><a href="<?=base_index();?>rekap-hasil-studi">Rekap Hasil Studi</a></li>
                        <li class="active">Rekap Hasil Studi List</li>
                    </ol>
                </section>
  ...
  <div class="row">
    <div class="col-xs-12">
      <div class="box">
         ...
         <div class="row">
           <div class="col-md-6">
              <h3 class="text-center">Form Filter Rekap Hasil Studi</h3>
           </div>
         </div>
             ...
             <div class="form-group">
                ...
                <div class="col-lg-4">
                  <select name="jur" id="jur" data-placeholder="Pilih Jurusan ..." class="form-control chzn-select" tabindex="2" method="post" >
                   <option value=""></option>
