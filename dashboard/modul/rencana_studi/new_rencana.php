...
<div class="box box-primary">
            ...
            <div class="box-body">
           <form class="form-horizontal" id="filter_kelas_form" method="post" action="<?=base_admin();?>modul/rencana_studi/download_data.php" target="_blank">
          <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <select id="angkatan_filter" name="angkatan_filter" data-placeholder="Pilih Angkatan ..." class="form-control chzn-select" tabindex="2">
                          ...
                          <?php
                          $angkatan = $db->query("select id_semester,view_semester.angkatan from mahasiswa inner join view_semester
                            on view_semester.id_semester=mahasiswa.mulai_smt
                            group by id_semester
                            order by id_semester desc");
                          foreach ($angkatan as $ak) {
                            echo "<option value='$ak->id_semester'>$ak->angkatan</option>";
                          }
                          ?>
                        </select>
                      </div>
                        ...
                        <select id="is_bayar" name="is_bayar" data-placeholder="Pilih Hari ..." class="form-control" tabindex="2">
                          ...
                          <option value="0">Belum Bayar</option>
                           <option value="2">Affirmasi</option>
...
<div class="modal" id="modal_setting_tagihan_mahasiswa" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"> <div class="modal-dialog modal-lg"> <div class="modal-content"><div class="modal-header"> <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button> <h4 class="modal-title"><?php echo $lang["add_button"];?>/ Lihat KRS Mahasiswa</h4> </div> <div class="modal-body" id="isi_setting_tagihan_mahasiswa"> </div> </div><!-- /.modal-content --> </div><!-- /.modal-dialog --> </div>
    ...
    <script type="text/javascript">
       $.ajax({ 
              type: 'POST',
              url: '<?=base_admin();?>modul/rencana_studi/rencana_studi_action.php?act=buat_view',
              data: {sem:'all'},
    ...
    $('#modal_cetak_single').modal({ keyboard: false,backdrop:'static' });
      ...
      var dataTable_jadwal = $("#dtb_kelas_jadwal").DataTable({
           ...
           'columnDefs': [ {
            ...
            'ajax':{
              url :'<?=base_admin();?>modul/rencana_studi/rencana_studi_data.php',
