...
<div class="box box-primary">
 ...
 <div class="alert alert-warning fade in error_data_delete" style="display:none">
          ...
          <i class="icon fa fa-warning"></i> <span class="isi_warning_delete"></span>
                                    ...
                                    <div class="col-sm-2 selected-data" style="text-align: right;padding-right: 10px;padding-top:5px;">2 Data Terpilih</div>
    ...
    $('#modal_cetak_single').modal({ keyboard: false,backdrop:'static' });
      ...
      var dataTable_jadwal = $("#dtb_kelas_jadwal").DataTable({
           ...
           'columnDefs': [ {
            ...
            'ajax':{
              url :'<?=base_admin();?>modul/rencana_studi/rencana_studi_dosen_data.php',
