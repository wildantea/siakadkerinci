...
<div class="box box-primary">
   <div class="box-header with-border">
          ...
          <div class="form-group">
                                ...
                                <?php
                                $session_filter_fakultas = getFilter(array('filter_krs' => 'fakultas'));
                                loopingProdi('filter_krs',$session_filter_fakultas);
                                ?>
                      </select>
                    </div>
              ...
              <div class="form-group">
                    ...
                    <div class="form-group">
                      <label for="Semester" class="control-label col-lg-2">Status Disetujui</label>
                        ...
                        <div class="col-lg-3">
                        <select id="status_bayar" name="status_bayar" data-placeholder="Pilih Hari ..." class="form-control" tabindex="2">
                           <option value="all">Semua</option>
                          <?php
                          $filter_session_status_sudah_bayar = getFilter(array('filter_krs' => 'status_bayar'));

                          $status_sudah_bayar = array('belum' => 'Belum Bayar','sudah' => 'Sudah Bayar','aff' => 'Affirmasi');

                          foreach ($status_sudah_bayar as $key_status_bayar => $val_status_bayar) {
                            if ((string)$filter_session_status_sudah_bayar==(string)$key_status_bayar) {
                              echo "<option value='$key_status_bayar' selected>$val_status_bayar</option>";
                            } else {
                              echo "<option value='$key_status_bayar'>$val_status_bayar</option>";
                            }
                          }
                          ?>
                        </select>
                    ...
                    <div class="form-group">
                      <label for="Semester" class="control-label col-lg-2">Status KRS</label>
                        <div class="col-lg-3">
                  ...
                  <ul class="dropdown-menu" role="menu">
                    <li class="cetak-data"><button type="submit" name="download_cetak" value="download_krs" class="btn cetak-data"><i class="fa fa-cloud-download"></i> Download Rekap KRS</button></li>
                    <li class="cetak-data"><button type="submit" name="download_cetak" value="download_krs_detail" class="btn cetak-data"><i class="fa fa-cloud-download"></i> Download KRS Detail</button></li>
                  </ul>
                </div>
                      </div><!-- /.form-group -->
                    </div>
  ...
  $('.show-filter').click(function(){
      ...
      var dtb_krs = $("#dtb_krs").DataTable({
          ...
          'columnDefs': [ {
            ...
            'ajax':{
              url :'<?=base_admin();?>modul/rencana_studi/krs_admin/rencana_studi_data.php',
