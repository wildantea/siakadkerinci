              ...
              <section class="content-header">
                  <h1>Rencana Studi</h1>
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Edit Rencana Studi</li>
                    </ol>
              </section>
                  ...
                  <div class="col-lg-12">
                      <div class="box box-solid box-primary">
                          <div class="box-header">
                              <h3 class="box-title">Edit Rencana Studi</h3>
                      ...
                      <div class="box-body">
                          <form id="edit_rencana_studi" method="post" class="form-horizontal" action="<?=base_admin();?>modul/rencana_studi/rencana_studi_action.php?act=up">
              ...
              <select name="mhs_id" data-placeholder="Pilih Mahasiswa..." class="form-control chzn-select" tabindex="2" >
               ...
               <?php foreach ($db->fetch_all("mahasiswa") as $isi) {
                  ...
                  if ($data_edit->mhs_id==$isi->mhs_id) {
                    echo "<option value='$isi->mhs_id' selected>$isi->nama</option>";
                  } else {
              ...
              <select name="sem_id" data-placeholder="Pilih Semester..." class="form-control chzn-select" tabindex="2" >
               ...
               <?php foreach ($db->fetch_all("semester") as $isi) {
                  ...
                  if ($data_edit->sem_id==$isi->sem_id) {
                    echo "<option value='$isi->sem_id' selected>$isi->sem_id</option>";
                  } else {
...
<div class="form-group">
              ...
              <select name="nilai_id" data-placeholder="Pilih Nilai..." class="form-control chzn-select" tabindex="2" >
               ...
               <?php foreach ($db->fetch_all("nilai_ref") as $isi) {
                  ...
                  if ($data_edit->nilai_id==$isi->nilai_id) {
                    echo "<option value='$isi->nilai_id' selected>$isi->nilai_huruf</option>";
                  } else {
            ...
            <div class="form-group">
                ...
                ?>
                  <input name="di_setujui" class="make-switch" type="checkbox">
                <?php
              }?>
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="pengubah" value="<?=$data_edit->pengubah;?>" class="form-control" >
                </div>
              </div><!-- /.form-group -->
          ...
          <div class="form-group">
              ...
              <div class="col-lg-10">
                <input type="text" id="tgl1" data-rule-date="true" name="tgl_perubahan" value="<?=$data_edit->tgl_perubahan;?>" class="form-control" >
              </div>
          </div><!-- /.form-group -->
          
                            <input type="hidden" name="id" value="<?=$data_edit->krs_id;?>">
                            <div class="form-group">
    ...
    $("#edit_rencana_studi").validate({
        ...
        submitHandler: function(form) {
            ...
            $(form).ajaxSubmit({
                ...
                data: $("#edit_rencana_studi").serialize(),
