...
if ($is_aktif_krs=='yes') {
       ...
       //  if ($data_krs->diambil>0) {
           ?>
             <button id="cetak_krs" data-sem="<?=$enc->enc($sem);?>" data-nim="<?=$enc->enc($data_mhs->nim);?>" class="btn btn-info"><i class="fa fa-print"></i>&nbsp;Cetak KRS</button>
           <?php
...
<script type="text/javascript">
      ...
      var dtb_rencana = $("#dtb_rencana").DataTable({
          ...
          },
          {
            ...
            'ajax':{
              url :"<?=base_admin();?>modul/rencana_studi/rencana_data_by_admin.php",
