...
?>
               ...
               // else {
              $jatah_sks = $db->fetch_custom_single("select fungsi_get_jatah_sks(".$data_mhs->nim.",".$sem.") as jatah_sks,fungsi_jml_sks_diambil(".$data_mhs->nim.",".$sem.") as diambil ");
                  ?>
  ...
  <td align="center" >  <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline "> <input type="checkbox" class="group-checkable bulk-check"  name="krs-<?= $k->id_matkul ?>" id="krs-<?= $k->id_matkul ?>" onchange="ambil_krs(this,<?= $sem.",".$k->id_matkul.",".$k->sks_tm.",".$data_mhs->nim ?>)" value="<?= $k->id_matkul ?>" checked> <span></span></label></td>  -->
                                           ...
                                           $show_kelas_full=true;
                                            ...
                                            && cek_sudah_history($data_mhs->nim,$k->id_matkul)['nilai']!='' ) {
                                              ?>
                                           <tr style="background:#ff8f00"">
  <td align="center" >  <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline "> <input type="checkbox" class="group-checkable bulk-check"  name="krs-<?= $k->id_matkul ?>" id="krs-<?= $k->id_matkul ?>" onchange="ambil_krs(this,<?= $sem.",".$k->id_matkul.",".$k->sks_tm.",".$data_mhs->nim ?>)" value="<?= $k->id_matkul ?>"> <span></span></label></td> 
                                           <?php
                                           $ket= "Sudah diambil dan sudah ada nilai untuk matkul ini";
                                           $disabled_select = "";
                                           $show_kelas_full=true;
