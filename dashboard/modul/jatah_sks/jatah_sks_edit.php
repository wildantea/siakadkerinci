...
$data_edit = $db->fetch_single_row("jatah_sks","id",$_POST['id_data']);
?>
  <style type="text/css"> .datepicker {z-index: 1200 !important; } </style>
   <div class="alert alert-danger error_data" style="display:none">
          ...
          <span class="isi_warning"></span>
            ...
            <form id="edit_jatah_sks" method="post" class="form-horizontal" action="<?=base_admin();?>modul/jatah_sks/jatah_sks_action.php?act=up">
                            
              <div class="form-group">
                <label for="Ip Minimal" class="control-label col-lg-2">Ip Minimal <span style="color:#FF0000">*</span></label>
                <div class="col-lg-10">
                  <input type="text" name="ip_min" value="<?=$data_edit->ip_min;?>" class="form-control" required>
                </div>
              </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="ip_mak" value="<?=$data_edit->ip_mak;?>" class="form-control" required>
                </div>
              </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="sks_mak" value="<?=$data_edit->sks_mak;?>" class="form-control" required>
                </div>
              </div><!-- /.form-group -->
