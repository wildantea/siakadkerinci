...
<table id="tabelku" class="table table-bordered table-striped" cellspacing="0" width="100%">
        ...
        <tr>
          <td class="info2"><strong>Kelas Matakuliah</strong></td>
...
?>
 ...
 <?php
        ...
        <?php
          ...
          ?>
          <th rowspan="2" style="padding-right:0;width: 7%;text-align: center;vertical-align: middle;background: #ffffff;color:#000">No</th>
          <?php
        }
        ?>
