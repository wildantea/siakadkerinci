...
<style type="text/css"> .datepicker {z-index: 1200 !important; } </style>
  <form  class="form-horizontal foto_banyak" id="sem" target="__Blank" action="<?=base_admin().'modul/pengelolahan_sesi_wisuda/cetak_pengelolahansesiwisuda.php'?>" method="post">
