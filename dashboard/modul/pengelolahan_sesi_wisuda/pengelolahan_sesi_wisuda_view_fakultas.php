        ...
        <div class="box-header">
            ...
            <div class="form-group">
              ...
              <div class="col-lg-4">
                <select id="priode_filter" name="priode_filter" data-placeholder="Pilih Semester ..." class="form-control chzn-select" tabindex="2">
                  <option value="all">Semua</option>
                  <?php
                    foreach ($db->query("select * from kelola_wisuda kw where kw.tgl_awal <= NOW() AND kw.tgl_akhir >= NOW()") as $isi) {
          ...
          <?php
            if (isset($_GET['jurusan_filter'])) {
              ...
              include 'table_wisuda_fakultas.php';
            }
          ?>
      </div><!-- /.box -->
    </div>
...
<script type="text/javascript">
  ...
  $("#form_filter").submit(function(){
      $('#loadnya').show();
        $.ajax({
            type: 'POST',
            url: '<?=base_admin();?>modul/pengelolahan_sesi_wisuda/tabl_wisuda_fakultas.php',
