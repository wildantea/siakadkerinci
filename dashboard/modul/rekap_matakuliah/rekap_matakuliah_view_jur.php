...
<!-- Content Header (Page header) -->
                <section class="content-header">
                    <h1>
                        Manage Rekap Matakuliah
                    </h1>
                        <ol class="breadcrumb">
                        <li><a href="<?=base_index();?>"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li><a href="<?=base_index();?>rekap-matakuliah">Rekap Matakuliah</a></li>
                        <li class="active">Rekap Matakuliah List</li>
                    </ol>
                </section>
  ...
  <div class="row">
    <div class="col-xs-12">
      <div class="box">
         ...
         <div class="row">
           <div class="col-md-6">
              <h3 class="text-center">Form Filter Rekap Matakuliah</h3>
           </div>
         </div>
 ...
 <div class="form-group">
                ...
                <div class="col-lg-4">
                  <select name="ang" id="ang" data-placeholder="Pilih Angkatan ..." class="form-control chzn-select" tabindex="2" >
                   <option value=""></option>
        ...
        <br><br>
         ...
         <?php
          if (isset($_GET['ang']) || isset($_GET['sem'])) {
           include 'tabel_rekap_mk_jur.php';
          }
          ?>
