<!-- Content Header (Page header) -->
                <section class="content-header">
                   ...
                   <ol class="breadcrumb">
                        ...
                        <li class="active">Detail Cuti Kuliah</li>
                    </ol>
                </section>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="box box-solid box-primary">
                            ...
                            <h3 class="box-title">Detail Cuti Kuliah</h3>
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" disabled="" value="<?=$data_edit->date_updated;?>" class="form-control">
                      ...
                      <a href="<?=base_index();?>cuti-kuliah" class="btn btn-success "><i class="fa fa-step-backward"></i> <?php echo $lang["back_button"];?></a>
