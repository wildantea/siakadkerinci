...
<?php
  ...
  $qq=$db->query("select cm.nim,m.nama,f.nama_resmi,j.nama_jur,jk.ket_keluar,cm.file_sk,cm.id_cuti from cuti_mahasiswa cm inner join mahasiswa m on cm.nim=m.nim 
...
<body onLoad="//window.print();">
  <div class="page-break">
    ...
    <br>
      <h2 align="center" style="margin-bottom: 10px;">DAFTAR CUTI MAHASISWA</h2>
...
<?php
  ...
  $q=$db->query("select cm.nim,m.nama,f.nama_resmi,j.nama_jur,jk.ket_keluar,cm.file_sk,cm.id_cuti from cuti_mahasiswa cm inner join mahasiswa m on cm.nim=m.nim 
    inner join jenis_keluar jk on cm.jenis_keluar=jk.id_jns_keluar 
    inner join fakultas f on cm.kode_fak=f.kode_fak 
    inner join jurusan j where cm.kode_jur=j.kode_jur $fakultas $jurusan group by cm.id_cuti");
...
?>
      ...
      <h4 align="right" style="margin-top: 50px;"></h4>
    </div>
  </div>
</body>
</html>
