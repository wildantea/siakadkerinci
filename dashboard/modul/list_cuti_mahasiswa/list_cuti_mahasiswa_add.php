...
<style type="text/css"> .datepicker {z-index: 1200 !important; } </style>
      <form id="input_list_cuti_mahasiswa" method="post" enctype="multipart/form-data" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/list_cuti_mahasiswa/list_cuti_mahasiswa_action.php?act=in">
                    ...
                    <?php
                      foreach ($db->fetch_all('jenis_keluar') as $isi) {
                        if ($isi->id_jns_keluar == '9') {
                          echo "<option name='jenis_keluar' value='$isi->id_jns_keluar' selected>$isi->ket_keluar</option>";
                        }
                      }
                    ?>
                  </select>
