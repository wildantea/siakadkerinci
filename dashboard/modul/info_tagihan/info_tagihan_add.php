...
<style type="text/css"> .datepicker {z-index: 1200 !important; } </style>
 <div class="alert alert-danger error_data" style="display:none">
      ...
      <form id="input_info_tagihan" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/info_tagihan/info_tagihan_action.php?act=in">
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="id_tagihan_prodi" placeholder="id_tagihan_prodi" class="form-control" >
                </div>
              </div><!-- /.form-group -->
