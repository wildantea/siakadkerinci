...
<table id="tabelku" class="table table-bordered table-striped" cellspacing="0" width="100%">
        ...
        <div class="row">
          ...
          <div class="nav-tabs-custom">
            ...
            <li class="active">
              <a href="#tab_0" data-toggle="tab"><i class="fa fa-user"></i> Dosen Pengajar </a>
            </li>
            <li>
              <a href="#tab_4" data-toggle="tab"><i class="fa fa-book"></i> RPS</a>
            </li>
            <li>
              <a href="#tab_1" data-toggle="tab"><i class="fa fa-calendar-o"></i> Pertemuan Kuliah </a>
            </li>
            <li>
              <a href="#tab_2" data-toggle="tab"><i class="fa fa-check"></i> Presensi & Materi <span class="approved-krs-count label label-primary pull-right"></span></a>
            </li>
            <li>
              <a href="#tab_3" data-toggle="tab"><i class="fa fa-users"></i> Peserta Kelas <span class="approved-krs-count label label-primary pull-right"><?=$kelas_data->approved_krs;?></span></a>
            </li>
            </ul>
            <div class="tab-content">
              ...
              <div class="tab-pane" id="tab_1">
                    <?php
                    include "pertemuan/tab_pertemuan.php";
                    ?>
              </div>
                            <!-- /.tab-pane -->
