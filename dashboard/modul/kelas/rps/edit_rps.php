...
?>
          ...
          <span class="isi_warning_rps"></span>
            ...
            <form id="input_s3_manager" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/kelas/rps/action.php?act=up">
              <div class="form-group">
                        <label for="File" class="control-label col-lg-2">File RPS <span style="color:#FF0000">*</span></label>
                        <div class="col-lg-10">
                            <input type="hidden" name="id_rps" value="<?=$_POST['id_rps'];?>">
