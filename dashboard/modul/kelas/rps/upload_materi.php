        ...
        <div class="box box-solid box-primary">
          <div class="box-header">
            <h3 class="box-title">Silakan Upload File Materi Kuliah</h3>
          </div>
          <div class="box-body">
         ...
         <div class="col-lg-10"> <a href="<?=base_url();?>upload/sample/rencana_pembelajaran_sample_new.xlsx" class="btn btn-success btn-flat"><i class="fa fa-cloud-download"></i> Download Contoh Template XLS</a></div>
            <form id="input_s3_manager" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/kelas/rps/action.php?act=in">
              <div class="form-group">
                        <label for="File" class="control-label col-lg-2">File Materi <span style="color:#FF0000">*</span></label>
                        <div class="col-lg-10">
