...
",$columns);
  ...
  foreach ($query as $value) {
    ...
    //$ResultData[] = '<a class="peserta-kelas" data-toggle="tooltip" data-title="Lihat Detail Kelas" data-id="'.$value->kelas_id.'" data-jadwal="'.$value->jadwal_id.'">'.$value->kode_mk.' - '.$value->nama_mk.' - SMT '.$value->semester.' ('.$value->total_sks.' SKS)'.'</a>';
    ...
    $ResultData[] = $cetak;
    //'<a data-toggle="tooltip" title="" class="btn btn-primary btn-xs peserta-kelas" data-original-title="Lihat Detail Kelas" data-id="'.$value->kelas_id.'" data-jadwal="'.$value->jadwal_id.'"><i class="fa fa-eye"></i> Detail</a> '.$cetak;
