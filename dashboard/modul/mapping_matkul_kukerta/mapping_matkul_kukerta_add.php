...
<style type="text/css"> .datepicker {z-index: 1200 !important; } </style>
 <div class="alert alert-danger error_data" style="display:none">
      ...
      <form id="input_mapping_matkul_kukerta" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/mapping_matkul_kukerta/mapping_matkul_kukerta_action.php?act=in">
            ...
            <select  id="kode_mk" name="kode_mk" data-placeholder="Pilih Kode MK ..." class="form-control chzn-select" tabindex="2" required>
               ...
               <?php foreach ($db->query("select m.id_matkul, m.kode_mk,m.nama_mk,k.kode_jur,j.nama_jur from matkul m 
                ...
                join jurusan j on j.kode_jur=k.kode_jur group by m.id_matkul ") as $isi) {
                  echo "<option value='$isi->kode_mk'>$isi->kode_mk $isi->nama_mk $isi->nama_jur</option>";
               } ?>
              </select> 
            </div>
                      </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="mk" placeholder="Nama Matkul" class="form-control" >
                </div>
              </div><!-- /.form-group -->
...
<script type="text/javascript">
    ...
    $("#input_mapping_matkul_kukerta").validate({
