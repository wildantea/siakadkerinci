...
<style type="text/css"> .datepicker {z-index: 1200 !important; } </style>
 <div class="alert alert-danger error_data" style="display:none">
      ...
      <form id="input_jenis_bukti" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/jenis_bukti/jenis_bukti_action.php?act=in">
                      
              <div class="form-group">
                <label for="Jenis Bukti" class="control-label col-lg-2">Jenis Bukti <span style="color:#FF0000">*</span></label>
                <div class="col-lg-10">
                  <input type="text" name="jenis_bukti" placeholder="Jenis Bukti" class="form-control" required>
                </div>
              </div><!-- /.form-group -->
