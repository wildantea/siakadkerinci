...
<!-- Content Header (Page header) -->
                <section class="content-header">
                    <h1>
                        ...
                        <li class="active">Setting Menu List</li>
                    </ol>
                </section>
                            ...
                            <div class="box">
                                ...
                                <?php
                                  foreach ($db->fetch_all("sys_menu") as $isi) {
                                      ...
                                      ?>
                                      <a href="<?=base_index();?>setting-menu/tambah" class="btn btn-primary "><i class="fa fa-plus"></i> <?php echo $lang["add_button"];?></a>
                                      <?php
                                          }
                                      }
                                  }
...
'service_permission'
      ...
      $dtb=$db2->query("select * from sys_menu  where is_menu_pendaftaran='Y' order by urutan_menu,type_menu asc");
...
foreach ($db2->query("select * from sys_menu  where is_menu_pendaftaran='Y' and tampil='Y' order by parent,urutan_menu asc ") as $items) {
