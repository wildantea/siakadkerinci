...
<section class="content-header">
  <h1>Manage Hasil Studi Permahasiswa</h1>
  <ol class="breadcrumb">
         ...
         <div class="box-body">
          <div class="box box-primary">
                ...
                <form id="form_cari_mahasiswa" method="GET" class="form-horizontal" action="">
                  ...
                  <div class="form-group">
                    <label for="nama" class="control-label col-lg-2 col-md-2 col-xs-4" style="text-align: left">IPK</label>
                     <div class="col-lg-10 col-md-10 col-xs-8">
                      <b>: <?= get_ipk($k->nim) ?></b>
                    </div>
                  </div>
                ...
                <?php
                   include 'table_hasil_studi_persemester.php';
                  ?>
              </div>
