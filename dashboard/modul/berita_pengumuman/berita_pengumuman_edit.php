              ...
              <section class="content-header">
                  <h1>Berita Pengumuman</h1>
                    <ol class="breadcrumb">
                        ...
                        <li>
                        <a href="<?=base_index();?>berita-pengumuman">Berita Pengumuman</a>
                        </li>
                        <li class="active">Edit Berita Pengumuman</li>
                    </ol>
              </section>
                  ...
                  <div class="col-lg-12">
                      <div class="box box-solid box-primary">
                          <div class="box-header">
                              <h3 class="box-title">Edit Berita Pengumuman</h3>
                      ...
                      <div class="box-body">
                          <form id="edit_berita_pengumuman" method="post" class="form-horizontal" action="<?=base_admin();?>modul/berita_pengumuman/berita_pengumuman_action.php?act=up">
          ...
          <div class="form-group">
            ...
            <div class="form-group">
                ...
                <?php
                            ...
                            <input type="hidden" name="id" value="<?=$data_edit->id_news;?>">
                            <div class="form-group">
...
<script type="text/javascript">
    ...
    $("#edit_berita_pengumuman").validate({
        ...
        submitHandler: function(form) {
            ...
            $(form).ajaxSubmit({
                ...
                data: $("#edit_berita_pengumuman").serialize(),
