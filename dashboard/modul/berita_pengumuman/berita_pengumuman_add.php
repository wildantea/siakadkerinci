<!-- Content Header (Page header) -->
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Add Berita Pengumuman</li>
        </ol>
    </section>
      ...
      <div class="col-lg-12">
        <div class="box box-solid box-primary">
          <div class="box-header">
            <h3 class="box-title">Add Berita Pengumuman</h3>
          ...
          <div class="box-body">
            <form id="input_berita_pengumuman" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/berita_pengumuman/berita_pengumuman_action.php?act=in">
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="judul" placeholder="Judul Berita / Pengumuman" class="form-control" required>
                </div>
              </div><!-- /.form-group -->
...
<script type="text/javascript">
    ...
    $("#input_berita_pengumuman").validate({
        ...
        submitHandler: function(form) {
            ...
            $(form).ajaxSubmit({
                ...
                data: $("#input_berita_pengumuman").serialize(),
