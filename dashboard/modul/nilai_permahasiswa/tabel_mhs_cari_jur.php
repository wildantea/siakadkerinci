                        ...
                        <table id="dtb_manual" class="table table-bordered table-striped">
                            ...
                            <tbody>
                              ...
                              $qq = $db->query("select m.mhs_id,m.nim,m.nama,j.nama_jur,m.stat_pd from mahasiswa m
                                                ...
                                                ($where_nama $or_kondisi $where_nim)");
                      /*        echo "select m.mhs_id,m.nim,m.nama,j.nama_jur,m.stat_pd from mahasiswa m
                              ...
                              if ($qq->rowCount()>0) {
                               ...
                               ?>
                                  ...
                                  <td>
                                    <?php
                                       echo '<a href="'.base_index().'nilai-permahasiswa/show-nilai/'.en($k->nim).'" data-id="'.$k->nim.'" class="btn edit_data btn-primary "><i class="fa fa-eye"></i> Lihat Nilai</a> '; 
