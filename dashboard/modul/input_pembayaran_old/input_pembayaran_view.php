<!-- Content Header (Page header) -->
                <section class="content-header">
                    <h1>
                        ...
                        <li><a href="<?=base_index();?>input-pembayaran">Input Pembayaran</a></li>
                        <li class="active">Input Pembayaran Mahasiswa List</li>
                    </ol>
                </section>
...
<div class="box-header with-border">
 ...
 <?php
  ...
  <div class="form-group">
                        ...
                        <div class="col-lg-5">
                        <select id="kode_prodi" name="kode_prodi" data-placeholder="Pilih Angkatan ..." class="form-control chzn-select" tabindex="2">
 <?php
...
foreach ($angkatan_exist as $ak) {
  ...
  <label for="Semester" class="control-label col-lg-2">Range Tanggal Waktu</label>
   <div class="col-lg-4">
        <div class="input-group">
                  ...
                  <input type="text" class="form-control pull-right" id="reservationtime" name="tanggal">
                </div>
 </div>
 </div>
                      <div class="form-group">
 ...
 <div class="alert alert-warning fade in error_data_delete" style="display:none">
    ...
    <div class="modal" id="modal_import_mat" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"> <div class="modal-dialog modal-lg"> <div class="modal-content"><div class="modal-header"> <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&nbsp;</span></button> <h4 class="modal-title">Lunas Massal</h4> </div> <div class="modal-body" id="isi_import_mat"> </div> </div><!-- /.modal-content --> </div><!-- /.modal-dialog --> </div>  
    </section><!-- /.content -->
