<!-- Content Header (Page header) -->
  <link href="https://siakad.stai-aljawami.ac.id/dashboard/assets/plugins/switch/bootstrap-switch.min.css" rel="stylesheet" type="text/css" />
...
?>
 <div class="alert alert-danger error_data" style="display:none">
          ...
          <span class="isi_warning"></span>
            ...
            <form id="input_mahasiswa" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/input_pembayaran/input_pembayaran_action.php?act=in">
...
<!-- <div class="form-group">
  ...
  <div class="form-group">
                        <label for="Semester" class="control-label col-lg-2">Jenis Pembayaran <span style="color:#FF0000">*</span></label>
                        <div class="col-lg-4">
                        <select id="jenis_pembayaran" name="jenis_pembayaran" data-placeholder="Pilih Jenis Pembayaran ..." class="form-control chzn-select" tabindex="2">
...
foreach ($angkatan_exist as $ak) {
  echo "<option value='$ak->kode_pembayaran'>$ak->nama_pembayaran</option>";
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-3">
                      <div class='input-group date' id="tgl1">
                        <input type='text' class="form-control hasDatepicker" type="text" name="tgl_bayar" required="" />
                    ...
                    <div class="col-lg-4">
                     <select id="bank" name="bank" data-placeholder="Pilih Bank ..." class="form-control chzn-select" tabindex="2" required="">
                      <option value="">Pilih Bank</option>
                      <?php 
                      $bank = $db->query("select * from keu_bank");
                      foreach ($bank as $bk) {
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4">
                          <div class="input-group">
                            ...
                            <input id="auto" type="text"  name="jumlah_bayar" class="form-control" data-a-sep="." data-a-dec="," required="">
                  ...
                  <div class="form-group">
                        ...
                        <div class="col-lg-10" id="detail_tagihan">
...
<script src="<?= base_url() ?>dashboard/assets/plugins/switch/bootstrap-switch.min.js" type="text/javascript"></script>
...
/*  function ganti(){
 ...
 /*    $.ajax({
              ...
              success: function(data) {*/
                ...
                if (nominal>jml) {
                   //alert("test");
                  var jml_auto = parseInt($("#auto").val());
  ...
  function set_bayar(id,jml_tagihan){
    ...
    if($("#cek-"+id).prop('checked') == true){
      if ($("#auto").val()=='') {
         ...
         $("#form-"+id).html("<input type='hidden' name='ket_id-"+id+"' id='ket_id-"+id+"' value='"+id+"'> <input type='text' class='form-control' id='data-"+id+"' name='data-"+id+"' value='"+jml_tagihan+"' onchange='updateJumlah(this.value,"+id+")' > <input type='hidden' class='form-control' id='data2-"+id+"' name='data2-"+id+"'>  ");
       var jml_bayar = parseInt($("#auto").val());
