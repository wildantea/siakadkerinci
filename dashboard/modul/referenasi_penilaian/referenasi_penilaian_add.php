<!-- Content Header (Page header) -->
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Add Referenasi Penilaian</li>
        </ol>
    </section>
      ...
      <div class="col-lg-12">
        <div class="box box-solid box-primary">
          <div class="box-header">
            <h3 class="box-title">Add Referenasi Penilaian</h3>
          ...
          <div class="box-body">
            <form id="input_referenasi_penilaian" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/referenasi_penilaian/referenasi_penilaian_action.php?act=in">
                      
              <div class="form-group">
                <label for="Nama Komponen" class="control-label col-lg-2">Nama Komponen </label>
                <div class="col-lg-10">
                  <input type="text" name="nama_komponen" placeholder="Nama Komponen" class="form-control" >
                </div>
              </div><!-- /.form-group -->
...
<script type="text/javascript">
    ...
    $("#input_referenasi_penilaian").validate({
        ...
        submitHandler: function(form) {
            ...
            $(form).ajaxSubmit({
                ...
                data: $("#input_referenasi_penilaian").serialize(),
