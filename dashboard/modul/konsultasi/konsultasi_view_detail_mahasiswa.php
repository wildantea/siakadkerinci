...
if ($check_jadwal) {
  ...
  if ($pertemuan_16) {
   ...
   $is_aktif_pasca_selesai = 0;
    ...
    if (date('Y-m-d') <= $krs_time->tgl_selesai_input_nilai && $is_aktif_pasca_mulai > 0 ) {
  ...
  <div class="alert alert-info alert-dismissible"> 
                ...
                Halaman ini digunakan untuk melihat konsultasi Mahasiswa bimbingan.<p></p>
    ...
    <div class="box box-success direct-chat direct-chat-success">
      <div class="box-header with-border">
       ...
       <?php
         if ($is_krs_mulai) {
          ?>
                <a data-id="1" class="btn btn-primary tambah_bimbingan"><i class="fa fa-plus"></i> Tambah bimbingan KRS</a>
 <?php
      }
      ?>
 <?php
         if ($is_aktif_tengah) {
          ?>
                  <a data-id="2" class="btn btn-primary tambah_bimbingan"><i class="fa fa-plus"></i> Tambah bimbingan Tengah Semester</a>
 <?php
      }
      ?>
         <?php
         if ($is_aktif_pasca_selesai) {
          ?>
                <a data-id="3" class="btn btn-primary tambah_bimbingan"><i class="fa fa-plus"></i> Tambah bimbingan Pasca Perkuliahan</a>
 <?php
      }
      ?>
      </div>
...
<script>
  ...
  konsultasi_3 = $("#konsultasi_3").DataTable({
            'paging' : false,
            'searching' : false,
           'bProcessing': true,
            'bServerSide': true,
