...
<?php
  ...
  <div class="col-lg-3 col-md-6">
    <div class="box box-success direct-chat direct-chat-success">
         <div class="box-header with-border" style="padding:13px"><h3 class="box-title">Konsultasi KRS</h3>
        <?php
         if ($is_krs_mulai) {
          ?>
        <div class="box-tools">
                <a data-id="1" class="btn btn-primary tambah_bimbingan"><i class="fa fa-plus"></i> Tambah bimbingan</a>
              </div>
 <?php
      }
      ?>
      ...
      <div class="box-body">
       <table id="konsultasi_1" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                  <th>Pertanyaan</th>
                                  <th>Jawaban</th>
      ...
      <div class="box-header with-border">
        ...
        <h3 class="box-title">Konsultasi Tengah Semester</h3>
         ...
         if ($is_aktif_tengah) {
          ?>
        <div class="box-tools">
                  <a data-id="2" class="btn btn-primary tambah_bimbingan"><i class="fa fa-plus"></i> Tambah bimbingan</a>
              </div>
 <?php
      }
      ?>
      ...
      <div class="box-body">
              <table id="konsultasi_2" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                  <th>Pertanyaan</th>
                                  <th>Jawaban</th>
      ...
      <div class="box-header with-border">
        <h3 class="box-title">Konsultasi Pasca Perkuliahan</h3>
         ...
         if ($is_aktif_pasca_selesai) {
          ?>
        <div class="box-tools">
                <a data-id="3" class="btn btn-primary tambah_bimbingan"><i class="fa fa-plus"></i> Tambah bimbingan</a>
              </div>
 <?php
      }
      ?>
...
<script>
  ...
  konsultasi_1 = $("#konsultasi_1").DataTable({
            'paging' : false,
            'searching' : false,
           'bProcessing': true,
            'bServerSide': true,
            'order': [],
            'ajax':{
              url :'<?=base_admin();?>modul/konsultasi/konsultasi_data.php',
 ...
 konsultasi_2 = $("#konsultasi_2").DataTable({
            'paging' : false,
            'searching' : false,
           'bProcessing': true,
            'bServerSide': true,
