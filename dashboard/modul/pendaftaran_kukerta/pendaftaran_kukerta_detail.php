<!-- Content Header (Page header) -->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="box box-solid box-primary">
                            ...
                            <h3 class="box-title">Detail Pendaftaran Kukerta</h3>
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" disabled="" value="<?=$data_edit->id_lokasi;?>" class="form-control">
                </div>
              </div><!-- /.form-group -->
              
                        
                      </form>
                      <a href="<?=base_index();?>pendaftaran-kukerta" class="btn btn-success "><i class="fa fa-step-backward"></i> <?php echo $lang["back_button"];?></a>
