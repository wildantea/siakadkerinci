...
$data_edit = $db->fetch_single_row("tb_data_file","id_file",$_POST['id_file']);
$id_label = $data_edit->id_file_label;
...
?>
   <div class="alert alert-danger error_data" style="display:none">
          ...
          <span class="isi_warning"></span>
            ...
            <form id="edit_berkas_file" method="post" class="form-horizontal" action="<?=base_admin();?>modul/biodata/berkas_file_action.php?act=up">
              </div><!-- /.form-group -->
...
<div class="form-group">
              ...
              <div class="fileinput fileinput-new" data-provides="fileinput">
                            ...
                            <div class="help-block"><?=$label->helper;?></div>
                          </div>
                    </div>
                      </div><!-- /.form-group -->

<input type="hidden" name="id" value="<?=$_POST['id_file'];?>">
              <div class="form-group">
                <div class="col-lg-12">
                      ...
                      $.each(responseText, function(index) {
                          ...
                          if (responseText[index].status=="die") {
                            ...
                            $(".notif_top_up").fadeOut(1000, function() {
                                window.location='<?=base_url();?>dashboard/index.php/biodata/edit/dokumen';
                            });
                          }
                    });
                }
