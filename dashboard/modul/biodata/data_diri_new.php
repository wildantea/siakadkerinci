...
?>
                                        <div class="form-group">
                                            <label for="Asal Sekolah" class="control-label col-lg-2">Jenis Asal Sekolah <span style="color:#FF0000">*</span></label>
                                            <div class="col-lg-10">
...
<div class="form-group">
                                            <label for="Kecamatan" class="control-label col-lg-2">NPSN - Nama Asal Sekolah/Lembaga <span style="color:#FF0000">*</span></label>
                                            <div class="col-lg-10">

                                                <select id="npsn" name="npsn" data-placeholder="Cari NPSN atau Nama Sekolah..." class="form-control" tabindex="2" required>
                                                    <?php
    ...
    if ($row) {
         echo "<option value='$row->npsn'>".$row->npsn.' - '.$row->nama_sekolah . ' (' . $row->kecamatan . ', ' . $row->kabupaten . ', ' . $row->provinsi . ')'."</option>";
    }
...
$("#npsn").select2({
    ajax: {
        url: '<?=base_admin();?>modul/biodata/get_asal_sekolah.php',
        dataType: 'json',
        data: function (params) {
            return {
                q: params.term // Send 'term' as 'q' to the server
            };
        },
        processResults: function (data) {
            return {
                results: data.results // Map the response to Select2 format
            };
        }
    },
