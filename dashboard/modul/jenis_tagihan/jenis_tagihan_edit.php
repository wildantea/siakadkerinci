...
$data_edit = $db->fetch_single_row("keu_jenis_tagihan","kode_tagihan",$_POST['id_data']);
?>
  <style type="text/css"> .datepicker {z-index: 1200 !important; } </style>
   <div class="alert alert-danger error_data" style="display:none">
          ...
          <span class="isi_warning"></span>
            ...
            <form id="edit_jenis_tagihan" method="post" class="form-horizontal" action="<?=base_admin();?>modul/jenis_tagihan/jenis_tagihan_action.php?act=up">
                            
              <div class="form-group">
                <label for="Kode Tagihan" class="control-label col-lg-2">Kode Tagihan <span style="color:#FF0000">*</span></label>
                <div class="col-lg-10">
                  <input type="text" name="kode_tagihan" value="<?=$data_edit->kode_tagihan;?>" class="form-control" required>
                </div>
              </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="nama_tagihan" value="<?=$data_edit->nama_tagihan;?>" class="form-control" required>
                </div>
              </div><!-- /.form-group -->
              <div class="form-group">
              ...
              <select  id="kode_pembayaran" name="kode_pembayaran" data-placeholder="Pilih Jenis Pembayaran..." class="form-control chzn-select" tabindex="2" required>
               ...
               <?php foreach ($db->fetch_all("keu_jenis_pembayaran") as $isi) {
                  ...
                  if ($data_edit->kode_pembayaran==$isi->kode_pembayaran) {
                    echo "<option value='$isi->kode_pembayaran' selected>$isi->nama_pembayaran</option>";
                  } else {
            ...
            <div class="form-group">
                ...
                ?>
                  <input name="syarat_krs" data-on-text="Ya" data-off-text="Tidak" class="make-switch" type="checkbox">
                <?php
              }?>
              ...
              <input type="hidden" name="id" value="<?=$data_edit->kode_tagihan;?>">
