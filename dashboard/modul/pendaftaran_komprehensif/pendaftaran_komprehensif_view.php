<!-- Content Header (Page header) -->
                            ...
                            <div class="box">
                                ...
                                <?php
                                  foreach ($db->fetch_all("sys_menu") as $isi) {
                                      ...
                                      <a id="jadwal_kompre" class="btn btn-success" href="<?=base_index();?>pendaftaran-komprehensif/jadwal"><i class="fa fa-calendar"></i> Penjadwalan </a>                                 
                                      <?php
                                          }
                                      }
                                  }
        ...
        <?php
            ...
            if (uri_segment(1)==$isi->url) {
              ...
              if ($role_act["up_act"]=="Y") {
                ...
                $setting = "<a data-id='+aData[indek]+'  class=\"btn btn-warning set_data \"><i class=\"fa fa-gear\" data-toggle=\"tooltip\" title=\"Setting Penguji\"></i></a>";
                $nilai = "<a data-id='+aData[indek]+'  class=\"btn btn-success nilai_data \"><i class=\"fa fa-check-square-o\" data-toggle=\"tooltip\" title=\"Setting Nilai\"></i></a>";
              } else {
                  $edit ="";
              }
            if ($role_act['del_act']=='Y') {
                $del = "<button data-id='+aData[indek]+' data-uri=".base_admin()."modul/pendaftaran_komprehensif/pendaftaran_komprehensif_action.php".' class="btn btn-danger hapus_dtb "><i class="fa fa-trash" data-toggle="tooltip" title="Delete"></i></button>';
            } else {
                $del="";
            }
                             }
    ...
    <!-- Modal Priode-->
    <div class="modal" id="modal_priode_pendaftaran_komprehensif" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"> <div class="modal-dialog modal-lg"> <div class="modal-content"><div class="modal-header"> <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button> <h4 class="modal-title"> Penjadwalan Komprehensif</h4> </div> <div class="modal-body" id="isi_priode_pendaftaran_komprehensif"> </div> </div><!-- /.modal-content --> </div><!-- /.modal-dialog --> </div>        
    </section><!-- /.content -->
    ...
    $("#priode_pendaftaran_komprehensif").click(function() {
          $.ajax({
              url : "<?=base_admin();?>modul/pendaftaran_komprehensif/pendaftaran_komprehensif_jadwal.php",
              type : "GET",
              success: function(data) {
                  $("#isi_priode_pendaftaran_komprehensif").html(data);
              }
          });

      $('#modal_priode_pendaftaran_komprehensif').modal({ keyboard: false,backdrop:'static',show:true });
