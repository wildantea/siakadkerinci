...
<style type="text/css"> .datepicker {z-index: 1200 !important; } </style>
 <div class="alert alert-danger error_data" style="display:none">
      ...
      <form id="input_periode_pembayaran" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/periode_pembayaran/periode_pembayaran_action.php?act=in">
               
           <div class="form-group">
                <label for="Tahun" class="control-label col-lg-3">Tahun Akademik</label>
                <div class="col-lg-4">
                  <input type="text" name="tahun" maxlength="4" placeholder="Contoh : 2017" class="form-control" required>
                </div>
              </div><!-- /.form-group -->
             <div class="form-group">
                        <label for="Periode" class="control-label col-lg-3">Jenis Semester</label>
                        <div class="col-lg-4">
            <select name="semester" data-placeholder="Pilih Jenis Semester ..." class="form-control chzn-select" tabindex="2" required>
...
<script type="text/javascript">
    ...
    $("#input_periode_pembayaran").validate({
