<!-- Content Header (Page header) -->
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li>
              <a href="<?=base_index();?>matakuliah">Matakuliah</a>
            </li>
            <li class="active">Add Matakuliah</li>
        </ol>
    </section>
    <?php

$prodi = $db->fetch_custom_single("select kurikulum.kur_id, jenjang_pendidikan.id_jenjang,jml_sks_wajib,jml_sks_pilihan,nama_kurikulum,jurusan.kode_jur,jurusan.nama_jur,jenjang_pendidikan.jenjang from
...
where kurikulum.kur_id=?",array('kurikulum.kur_id' =>uri_segment(3)));
?>
    <!-- Main content -->
    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="box box-solid box-primary">
          ...
          <div class="box-body">
            <form id="input_matkul" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/kurikulum/matkul_action.php?act=in">
            ...
            <div class="form-group">
                <label for="Kurikulum" class="control-label col-lg-2">Kurikulum <span style="color:#FF0000">*</span></label>
                <div class="col-lg-9">
                  <select name="kur_id" id="tb_data_kurikulum_kurikulum" data-placeholder="Pilih Kurikulum ..." class="form-control chzn-select" tabindex="2" required>
                  </select>
                </div>
            </div><!-- /.form-group -->
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                <label for="Nama Matakuliah" class="control-label col-lg-2">Nama Matakuliah Inggris</label>
                <div class="col-lg-10">
                  <input type="text" name="nama_asing" class="form-control" required>
                </div>
              </div><!-- /.form-group -->
            ...
            <select name="id_tipe_matkul" data-placeholder="Jenis Mata Kuliah ..." class="form-control chzn-select" tabindex="2" >
              ...
              <div class="form-group">
                ...
                <div class="col-lg-1">
                  <input type="text" name="semester" class="form-control" maxlength="1" onkeypress="return isNumberKey(event)" required="">
                </div>
          ...
          <div class="form-group">
                ...
                <div class="input-group" >
                    <input type="text" value="0" maxlength="2" onkeypress="return isNumberKey(event)" name="total_sks"  class="form-control" readonly="">
              ...
              <div class="form-group">
                ...
                <div class="col-lg-1">
                  <input type="text" value="0" maxlength="2" onkeypress="return isNumberKey(event)" name="sks_tm"  class="form-control" >
                </div>
              </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-1">
                  <input type="text" value="0" name="sks_prak" maxlength="2" onkeypress="return isNumberKey(event)"  class="form-control" >
                </div>
              </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-1">
                  <input type="text" value="0" name="sks_prak_lap" maxlength="2" onkeypress="return isNumberKey(event)" class="form-control" >
                </div>
              </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-1">
                  <input type="text" value="0" name="sks_sim" maxlength="2" onkeypress="return isNumberKey(event)" class="form-control" >
                </div>
              </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="metode_pelaksanaan_kuliah" placeholder="Metode Pembelajaran" class="form-control" >
                </div>
              </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-5">
                <div class="input-group">
                    <input type="text" autocomplete="off" class="form-control desimal" name="bobot_minimal_lulus"  />
                    <span class="input-group-addon" style="border: none">
...
$.ajax({
type : "post",
url : "<?=base_admin();?>modul/matakuliah/get_kurikulum.php",
data : {program_studi:this.value},
success : function(data) {
    $("#tb_data_kurikulum_kurikulum").html(data);
    $("#tb_data_kurikulum_kurikulum").trigger("chosen:updated");
