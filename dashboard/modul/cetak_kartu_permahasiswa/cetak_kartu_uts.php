...
$foto=$db->fetch_single_row('sys_users','id','$mhs_id');
	


 $qq = $db->query("SELECT fk.nama_resmi, j.kode_jur,j.nama_jur FROM mahasiswa m 
...
$qqq = $db->query("SELECT js.`jns_semester`, sf.`tahun`, sf.`tahun`+1 FROM akm a 
JOIN semester s ON s.id_semester=a.sem_id 
...
<!-- saved from url=(0184)https://siakad.fst.uinsgd.ac.id/gtakademik/rencana_studi/kartu_ujian_tengah_cetak.php?w=a2f75ppqmuffcb2uupur1f28d&x=a2f75luuupffcb2urrll1f28d&y=a2f75ffcb20$1f28d&z=a2f75ffcb2pur3$1f28d -->
<html class="gr__siakad_fst_uinsgd_ac_id"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<title>CETAK KARTU UJIAN</title>
<link rel="stylesheet" type="text/css" href="./CETAK KARTU UJIAN_files/a_sia_cetak.css">
<link rel="stylesheet" type="text/css" media="print" href="./CETAK KARTU UJIAN_files/a_sia_cetak_media_print.css">
...
<body onload="window.print();" data-gr-c-s-loaded="true">
<div class="page-portrait">

<div class="page-separo-letter">
<div class="nobreak">
   ...
   <table>
    ...
    <!--table>
      <tr>
        ...
        <td><h1></h1><h3>FAKULTAS SAINS DAN TEKNOLOGI</h3></td>
      </tr>
    </table-->
    ...
    <table width="100%">
      ...
      <tr>
        ...
        <td nowrap="nowrap">:</td>
        <td nowrap="nowrap"><?= $m->mulai_smt ?></td>
      </tr>
<!--      <tr>
...
JOIN ruang_ref r ON j.ruang_id=r.ruang_id
JOIN kelas kl ON kl.`kelas_id` = kr.`id_kelas`
where k.mhs_id='$mhs_id' and s.id_semester='$sem'");
      ...
      <table align="right" width="50%">
        <tbody><tr>
          <td width="50%" rowspan="3" align="center" valign="top">
            <div style="width: 1.5cm; height: 2cm; border: 1px solid #000;"><br><br><center><span class="foto_profil"><img src="../../upload/back_profil_foto/<?= $foto->foto_user; ?>"></span></center></div>
          </td>
