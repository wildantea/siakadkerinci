...
<style type="text/css"> .datepicker {z-index: 1200 !important; } </style>
  <form  class="form-horizontal foto_banyak" id="sem" target="__Blank" action="<?=base_admin().'modul/pendaftaran_ppl/cetak_ppl.php'?>" method="post">
<?php
...
?>
    ...
    <div class="form-group">
        ...
        <div class="col-lg-10">
          <select id="priode_filter" name="priode_filter" data-placeholder="Pilih Priode ppl ..." class="form-control chzn-select" tabindex="2">
             <option value=""></option>
             <?php
             echo "<option value='all'>Semua</option>";
      ...
      <div class="col-lg-10">
        <select id="lokasi_filter" name="lokasi_filter" data-placeholder="Pilih Lokasi ..." class="form-control chzn-select" tabindex="2">
          <option value=""></option>
           <?php
           echo "<option value='all'>Semua</option>";
           foreach ($db->fetch_all("lokasi_ppl") as $isi) {
