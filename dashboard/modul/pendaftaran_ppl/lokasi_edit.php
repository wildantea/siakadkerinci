...
$data_edit = $db->fetch_single_row("lokasi_ppl","id_lokasi",$_POST['id_data']);
?>
<style type="text/css"> .datepicker {z-index: 1200 !important; } </style>
<form id="edit_lokasi" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/pendaftaran_ppl/pendaftaran_ppl_action.php?act=up_lokasi">
        ...
        <div class="form-group">
          ...
          <div class="col-lg-10">
            <select id="id_periode" name="id_periode" data-placeholder="Pilih Periode..." class="form-control chzn-select" tabindex="2">
               <?php
               foreach ($db->query("select * from priode_ppl order by priode desc") as $isi) {
          ...
          <div class="col-lg-10">
            <table class="table">
              ...
              <tbody>
                ...
                foreach ($qj as $kj) {
                  $qq = $db->query("select kuota from kuota_jurusan_ppl where id_lokasi='$data_edit->id_lokasi' and kode_jur='$kj->kode_jur'  ");
                  $kuota ="";
                  if ($qq->rowCount()>0) {
                    foreach ($qq as $kk) {
                      $kuota = $kk->kuota;
        ...
        <div class="form-group">
         ...
         <div class="form-group">
          ...
          <div class="col-lg-10">
            ...
            <input type="radio" name="ket" value="PPL" <?php echo "checked"; ?>> PPL &nbsp;
          </div>
        </div>
