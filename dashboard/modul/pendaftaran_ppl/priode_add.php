...
<form id="input_priode" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/pendaftaran_ppl/pendaftaran_ppl_action.php?act=in_priode">
      <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="col-lg-9">
            <input id="tgl2" type="text" autocomplete="off" name="tgl2" placeholder="Awal Pendaftaran Kukerta" class="form-control" required>
          </div>
        </div><!-- /.form-group -->                    
        ...
        <div class="form-group">
          ...
          <div class="col-lg-9">
            <input id="tgl3" type="text" autocomplete="off" name="tgl3" placeholder="Akhir Pendaftaran Kukerta" class="form-control" required>
          </div>
        </div><!-- /.form-group -->       
        <div class="form-group">
          <label for="Nim" class="control-label col-lg-3">Tanggal Awal Daftar <span style="color:#FF0000">*</span></label>
          <div class="col-lg-9">
            <input id="tgl4" type="text" autocomplete="off" name="tgl_awal_daftar" autocomplete="off" placeholder="Awal Pendaftaran Kukerta" class="form-control"  required>
          </div>
        </div><!-- /.form-group -->                    
        ...
        <div class="form-group">
          ...
          <div class="col-lg-9">
            <input id="tgl5" type="text" name="tgl_akhir_daftar" autocomplete="off" placeholder="Akhir Pendaftaran Kukerta" class="form-control"  autocomplete="off" required>
          </div>
        </div>  
        ...
        <div class="form-group">
          ...
          <div class="col-lg-9">
            <input  type="text" id="tgl7" name="tgl_awal_input_nilai" autocomplete="off" placeholder="Awal Input Nilai" class="form-control tgl" autocomplete="off" required>
          </div>
        </div><!-- /.form-group -->                    
        ...
        <div class="form-group">
          ...
          <div class="col-lg-9">
            <input  type="text" id="tgl6" name="tgl_akhir_input_nilai" autocomplete="off" placeholder="Akhir Input Nilai" class="form-control tgl" autocomplete="off" required>
          </div> 
        </div>     
