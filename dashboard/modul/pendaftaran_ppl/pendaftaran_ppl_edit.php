...
session_check();
$data_edit = $db->fetch_single_row("ppl","id_kkn",$_POST['id_data']);
if($_SESSION['level']=='3'){
    $up_url = "up";
} else {
    $up_url = "up_admin";
...
?>
  <style type="text/css"> .datepicker {z-index: 1200 !important; } </style>
            <form id="edit_pendaftaran_kukerta" method="post" class="form-horizontal" action="<?=base_admin();?>modul/pendaftaran_ppl/pendaftaran_ppl_action.php?act=<?=$up_url;?>">
        ...
        submitHandler: function(form) {
            ...
            if (data == "good") {
              ...
              $(".notif_top_up").fadeOut(1000, function() {
               $('#modal_pendaftaran_ppl_edit').modal('hide');
              });
            }  
            // else if (data == "die") {
