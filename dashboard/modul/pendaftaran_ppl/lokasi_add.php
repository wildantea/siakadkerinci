...
<form id="input_lokasi" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/pendaftaran_ppl/pendaftaran_ppl_action.php?act=in_lokasi">
                
        <div class="form-group">
          <label for="Nim" class="control-label col-lg-2">Lokasi PPL<span style="color:#FF0000">*</span></label>
          <div class="col-lg-10">
            <input type="text" name="lokasi" placeholder="Lokasi PPL" class="form-control" required>
          </div>
        </div>
