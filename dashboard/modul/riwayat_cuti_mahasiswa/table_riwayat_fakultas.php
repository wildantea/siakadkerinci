<!-- Content Header (Page header) -->
    ...
    <div class="modal" id="modal_riwayat_cuti_mahasiswa" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"> <div class="modal-dialog modal-lg"> <div class="modal-content"><div class="modal-header"> <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button> <h4 class="modal-title"><?php echo $lang["add_button"];?> Riwayat Cuti Mahasiswa</h4> </div> <div class="modal-body" id="isi_riwayat_cuti_mahasiswa"> </div> </div><!-- /.modal-content --> </div><!-- /.modal-dialog --> </div>
    ...
    $('#modal_riwayat_cuti_mahasiswa').modal({ keyboard: false,backdrop:'static' });
      ...
      var dataTable = $("#dtb_riwayat_cuti_mahasiswa").DataTable({
           "fnCreatedRow": function( nRow, aData, iDataIndex ) {
            ...
            $('td:eq('+indek+')', nRow).html(' <a href="<?=base_index();?>riwayat-cuti-mahasiswa/detail/'+aData[indek]+'" class="btn btn-success "><i class="fa fa-eye"></i></a> <?=$edit;?> <?=$del;?>');
