...
<style type="text/css"> .datepicker {z-index: 1200 !important; } </style>
 <div class="alert alert-danger error_data" style="display:none">
      ...
      <form id="input_sinkron_transaksi_briva" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/sinkron_transaksi_briva/sinkron_transaksi_briva_action.php?act=in">
                      
              <div class="form-group">
                <label for="no_briva" class="control-label col-lg-2">no_briva </label>
                <div class="col-lg-10">
                  <input type="text" name="no_briva" placeholder="no_briva" class="form-control" >
                </div>
              </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="teller_id" placeholder="teller_id" class="form-control" >
                </div>
              </div><!-- /.form-group -->
...
<script type="text/javascript">
    ...
    $("#input_sinkron_transaksi_briva").validate({
