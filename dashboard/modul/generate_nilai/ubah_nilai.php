...
<form id="edit_setting_tagihan_mahasiswa" method="post" class="form-horizontal"
  action="<?= base_admin(); ?>modul/generate_nilai/generate_nilai_act.php">
  <!--0
                    <div class="form-group">
              <label for="Tanggal Mulai" class="control-label col-lg-3">Nilai Angka</label>
              <div class="col-lg-3">
              <input type="text" class="form-control desimal" name="nilai_angka" required>
              </div>
          </div> -->
  ...
  <div class="form-group">
    ...
    <div class="col-lg-9">
      <button type="submit" class="btn btn-primary">Generate Nilai Sekarang</button>
      <button type="button" class="btn btn-default" data-dismiss="modal">Batal</button>
    </div>
  </div><!-- /.form-group -->

</form>
<script src="<?= base_admin(); ?>assets/dist/js/desimal.js"></script>
