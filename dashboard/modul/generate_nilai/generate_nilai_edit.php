...
$data_edit = $db->fetch_single_row("generate_nilai","id",$_POST['id_data']);
?>
  <style type="text/css"> .datepicker {z-index: 1200 !important; } </style>
   <div class="alert alert-danger error_data" style="display:none">
          ...
          <span class="isi_warning"></span>
            ...
            <form id="edit_generate_nilai" method="post" class="form-horizontal" action="<?=base_admin();?>modul/generate_nilai/generate_nilai_action.php?act=up">
              ...
              <select  id="sem_id" name="sem_id" data-placeholder="Pilih Semester..." class="form-control chzn-select" tabindex="2" required>
               ...
               <?php foreach ($db->fetch_all("semester_ref") as $isi) {
                  ...
                  if ($data_edit->sem_id==$isi->id_semester) {
                    echo "<option value='$isi->id_semester' selected>$isi->semester</option>";
                  } else {
...
<div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="total" value="<?=$data_edit->total;?>" class="form-control" >
                </div>
              </div><!-- /.form-group -->
