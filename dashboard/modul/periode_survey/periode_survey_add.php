<!-- Content Header (Page header) -->
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Add Periode Survey</li>
        </ol>
    </section>
      ...
      <div class="col-lg-12">
        <div class="box box-solid box-primary">
          <div class="box-header">
            <h3 class="box-title">Add Periode Survey</h3>
          ...
          <span class="isi_warning"></span>
            ...
            <form id="input_periode_survey" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/periode_survey/periode_survey_action.php?act=in">
              
           <div class="form-group">
                <label for="Tahun" class="control-label col-lg-3">Tahun Akademik</label>
                <div class="col-lg-3">
                  <input type="text" name="tahun" placeholder="Contoh : 2025" class="form-control" maxlength="4" required>
                </div>
              </div><!-- /.form-group -->
             <div class="form-group">
                        <label for="Periode" class="control-label col-lg-3">Jenis Semester</label>
                        <div class="col-lg-3">
            <select name="id_jns_semester" data-placeholder="Pilih Jenis Semester ..." class="form-control chzn-select" id="id_jns_semester" tabindex="2" required>
               <option value=""></option>
          ...
          <div class="input-group date tgl_picker" data-target="periode_awal_mulai">
              <input type="text" class="form-control tgl_picker_input" readonly  required>
              <span class="input-group-addon">
                        <span class="glyphicon glyphicon-calendar"></span>
                    </span>
              
              </div>
              <input type="hidden" name="periode_awal_mulai">
          </div>
  ...
  <div class="col-lg-2 col-xs-7">
          <div class="input-group date tgl_picker" data-target="periode_awal_selesai">
              ...
              <input type="hidden" name="periode_awal_selesai">
          </div>
          ...
          <div class="input-group date tgl_picker" data-target="periode_tengah_mulai">
              ...
              <input type="hidden" name="periode_tengah_mulai">
          </div>
  ...
  <div class="col-lg-2 col-xs-7">
          <div class="input-group date tgl_picker" data-target="periode_tengah_selesai">
              ...
              <input type="hidden" name="periode_tengah_selesai">
          </div>
          ...
          <div class="input-group date tgl_picker" data-target="periode_akhir_mulai">
              ...
              <input type="hidden" name="periode_akhir_mulai">
          </div>
  ...
  <div class="col-lg-2 col-xs-7">
          <div class="input-group date tgl_picker" data-target="periode_akhir_selesai">
              ...
              <input type="hidden" name="periode_akhir_selesai">
          </div>
  ...
  <div class="form-group">
          ...
          <div class="input-group date tgl_picker" data-target="periode_lainya_mulai">
              ...
              <input type="hidden" name="periode_lainya_mulai" >
          </div>
  ...
  <div class="col-lg-2 col-xs-7">
          <div class="input-group date tgl_picker" data-target="periode_lainya_selesai">
              ...
              <input type="hidden" name="periode_lainya_selesai" >
          </div>
