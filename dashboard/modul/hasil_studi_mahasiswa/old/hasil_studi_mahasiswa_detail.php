<!-- Content Header (Page header) -->
                <section class="content-header">
                   ...
                   <ol class="breadcrumb">
                        ...
                        <li class="active">Detail Hasil Studi Mahasiswa</li>
                    </ol>
                </section>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="box box-solid box-primary">
                            ...
                            <h3 class="box-title">Detail Hasil Studi Mahasiswa</h3>
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" disabled="" value="<?=$data_edit->id_krs_detail;?>" class="form-control">
                </div>
              </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" disabled="" value="<?=$data_edit->sks;?>" class="form-control">
                </div>
              </div><!-- /.form-group -->
