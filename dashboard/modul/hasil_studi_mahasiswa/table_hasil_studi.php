...
<div class="box-body table-responsive">
    ...
    <table id="dtb_manual" class="table table-bordered table-striped">
        ...
        <tbody>
          <?php
          $no=1;
          $where_nama = $_GET['nama']=="" ? "" : " and m.nama like '%".clean($_GET['nama'])."%'";
          $or_kondisi = $where_nama!="" ? "or" : "";
          $where_jur  = $_GET['jur']!="" ? "and m.jur_kode='".de($_GET['jur'])."'" : "";
          $where_nim =  ""; 
          if ($_GET['nim']!='') {
            $where_nim  ="and m.nim like '%".clean($_GET['nim'])."%'";
          }
          ...
          //                   join fakultas f on f.kode_fak=j.fak_kode where 1=1 
          //                   $where_nama  $where_nim";
          //                   die();
