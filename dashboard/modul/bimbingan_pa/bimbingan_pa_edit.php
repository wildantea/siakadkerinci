<!-- Content Header (Page header) -->
              <section class="content-header">
                  <h1>Bimbingan Pa</h1>
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Edit Bimbingan Pa</li>
                    </ol>
              </section>
                  ...
                  <div class="col-lg-12">
                      <div class="box box-solid box-primary">
                          <div class="box-header">
                              <h3 class="box-title">Edit Bimbingan Pa</h3>
                      ...
                      <div class="box-body">
                       <div class="alert alert-danger error_data" style="display:none">
                        ...
                        <span class="isi_warning"></span>
                          ...
                          <form id="edit_bimbingan_pa" method="post" class="form-horizontal" action="<?=base_admin();?>modul/bimbingan_pa/bimbingan_pa_action.php?act=up">
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="pertanyaan" value="<?=$data_edit->pertanyaan;?>" class="form-control" required>
                </div>
              </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="jawaban" value="<?=$data_edit->jawaban;?>" class="form-control" required>
                </div>
              </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="tgl_tanya" value="<?=$data_edit->tgl_tanya;?>" class="form-control" >
                </div>
              </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="tgl_jawab" value="<?=$data_edit->tgl_jawab;?>" class="form-control" >
                </div>
              </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="id_semester" value="<?=$data_edit->id_semester;?>" class="form-control" >
                </div>
              </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="kategori_konsultasi" value="<?=$data_edit->kategori_konsultasi;?>" class="form-control" >
                </div>
              </div><!-- /.form-group -->
