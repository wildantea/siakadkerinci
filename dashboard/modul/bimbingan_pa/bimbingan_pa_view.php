                            ...
                            <div class="box">
                                ...
                                <?php
                                  foreach ($db->fetch_all("sys_menu") as $isi) {
                                      ...
                                      ?>
                                      <a href="<?=base_index();?>bimbingan-pa/tambah" class="btn btn-primary "><i class="fa fa-plus"></i> <?php echo $lang["add_button"];?></a>
                                      <?php
                                          }
                                      }
                                  }
 ...
 <div class="alert alert-warning fade in error_data_delete" style="display:none">
      ...
      var dtb_bimbingan_pa = $("#dtb_bimbingan_pa").DataTable({
           "fnCreatedRow": function( nRow, aData, iDataIndex ) {
            ...
            $('td:eq('+indek+')', nRow).html('<a href="<?=base_index();?>bimbingan-pa/detail/'+aData[indek]+'"  class="btn btn-success btn-sm" data-toggle="tooltip" title="Detail"><i class="fa fa-eye"></i></a> <?=$edit;?> <?=$del;?>');
  ...
  $('#dtb_bimbingan_pa').on('draw.dt', function() {
          init_selected()
      });
  ...
  $(document).on('click', '#dtb_bimbingan_pa tbody tr td', function(event) {
  ...
  function check_selected() {
      var table_select = $('#dtb_bimbingan_pa tbody tr.selected');
  ...
  function select_deselect(type) {
      if (type == 'select') {
          $('#dtb_bimbingan_pa tbody tr').addClass('DTTT_selected selected')
      } else {
          $('#dtb_bimbingan_pa tbody tr').removeClass('DTTT_selected selected')
      }
      init_selected()
  }
...
/* Add a click handler for the delete row */
  $('#bulk_delete').click( function() {
    var anSelected = fnGetSelected( dtb_bimbingan_pa );
    ...
    $('#ucing').modal({ keyboard: false }).one('click', '#delete', function (e) {
        ...
        $.ajax({
            type: 'POST',
            dataType: 'json',
            url: '<?=base_admin();?>modul/bimbingan_pa/bimbingan_pa_action.php?act=del_massal',
