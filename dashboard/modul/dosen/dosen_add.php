...
<style type="text/css"> .datepicker {z-index: 1200 !important; } </style>
 <div class="alert alert-danger error_data" style="display:none">
      ...
      <form id="input_dosen" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/dosen/dosen_action.php?act=in">
              ...
              <div class="form-group">
                ...
                <div class="col-lg-9">
                  <input type="text" name="nip" placeholder="Nomor Identitas (NIP, dll)" class="form-control" required>
                </div>
              </div><!-- /.form-group -->
...
<div class="form-group">
  ...
  <div class="col-lg-9">
    <input type="text" name="nidn" placeholder="Nomor Induk Dosen Nasional (NIDN)" class="form-control" >
  </div>
</div>
              ...
              <div class="form-group">
                ...
                <div class="col-lg-9">
                  <input type="text" name="nama_dosen" placeholder="Nama Lengkap dan Gelar" class="form-control" required>
                </div>
              </div><!-- /.form-group -->
              <div class="form-group">
                <label for="Nama Lengkap dan Gelar" class="control-label col-lg-3">Email</label>
                <div class="col-lg-9">
                  <input type="text" name="email" placeholder="Email Dosen" class="form-control" data-rule-email="true">
                </div>
              </div><!-- /.form-group -->
              <div class="form-group">
                <label for="Nama Lengkap dan Gelar" class="control-label col-lg-3">No HP</label>
                <div class="col-lg-9">
                  <input type="text" name="no_hp" placeholder="No HP Dosen" class="form-control" onkeypress="return isNumberKey(event)">
                </div>
              </div><!-- /.form-group -->
              <div class="form-group">
