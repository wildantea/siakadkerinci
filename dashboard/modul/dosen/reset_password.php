...
<?php
$id_mhs = $db->fetch_custom_single("select sys_users.id from sys_users inner join dosen on sys_users.username=dosen.nip where dosen.id_dosen=?",array('id' => $_POST['id_data']));
