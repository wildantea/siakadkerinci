  ...
  <style type="text/css"> .datepicker {z-index: 1200 !important; } </style>
   <div class="alert alert-danger error_data_tanggal" style="display:none">
          ...
          <span class="isi_warning_tanggal"></span>
            ...
            <form id="edit_setting_tagihan_mahasiswa" method="post" class="form-horizontal" action="<?=base_admin();?>modul/dosen/dosen_action.php?act=up_status_aktif">

            <div class="form-group">
                <label for="Aktif" class="control-label col-lg-3">Status Aktif </label>
                <div class="col-lg-9">
               <input name="aktif" class="make-switch" type="checkbox" data-on-text="Aktif" data-off-text="Tidak" checked>
