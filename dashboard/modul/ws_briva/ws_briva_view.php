<!-- Content Header (Page header) -->
                            ...
                            <div class="box">
                                ...
                                <?php
                                  foreach ($db->fetch_all("sys_menu") as $isi) {
                                      ...
                                      ?>
                                      <a href="<?=base_index();?>ws-briva/tambah" class="btn btn-primary "><i class="fa fa-plus"></i> <?php echo $lang["add_button"];?></a>
                                      <?php
                                          }
                                      }
                                  }
 ...
 <div class="alert alert-warning fade in error_data_delete" style="display:none">
          ...
          <i class="icon fa fa-warning"></i> <span class="isi_warning_delete"></span>
                        ...
                        <table id="dtb_ws_brivax" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                            ...
                            <tbody> 
                              <tr>
                                <td>1</td>
                                <td>Create Briva</td>
                                <td><a class="btn btn-success" href="<?= base_url() ?>dashboard/index.php/ws-briva/create">Akses WS</a></td>
                              </tr>
                               <tr>
                                <td>2</td>
                                <td>Get Status</td>
                                <td><a class="btn btn-success" href="<?= base_url() ?>dashboard/index.php/ws-briva/get_status">Akses WS</a></td>
                              </tr>
                              <tr>
                                <td>3</td>
                                <td>Get Report</td>
                                <td><a class="btn btn-success" href="<?= base_url() ?>dashboard/index.php/ws-briva/get_report">Akses WS</a></td>
                              </tr>
                              <tr>
                                <td>4</td>
                                <td>Delete</td>
                                <td><a class="btn btn-success" href="<?= base_url() ?>dashboard/index.php/ws-briva/delete_briva">Akses WS</a></td>
                              </tr>
                                <tr>
                                <td>5</td>
                                <td>Update</td>
                                <td><a class="btn btn-success" href="<?= base_url() ?>dashboard/index.php/ws-briva/update_briva">Akses WS</a></td> 
                              </tr>
                            </tbody>
                        </table>
                    </div><!-- /.box-body -->
