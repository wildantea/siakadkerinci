<!-- Content Header (Page header) -->
                            ...
                            <div class="box">
                                ...
                                <?php
                                  foreach ($db->fetch_all("sys_menu") as $isi) {
                                      ...
                                      ?>
                                      <a href="<?=base_index();?>aktivitas-kuliah-mahasiswa/tambah" class="btn btn-primary "><i class="fa fa-plus"></i> <?php echo $lang["add_button"];?></a>
                                      <?php
                                          }
                                      }
                                  }
 ...
 <div class="alert alert-warning fade in error_data_delete" style="display:none">
          ...
          <i class="icon fa fa-warning"></i> <span class="isi_warning_delete"></span>
                        ...
                        <table id="dtb_aktivitas_kuliah_mahasiswa" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                  <th>No</th>
                                  <th>mhs_nim</th>
        ...
        <?php
            ...
            if (uri_segment(1)==$isi->url) {
              ...
              if ($role_act["up_act"]=="Y") {
                $edit = "<a data-id='+aData[indek]+' href=".base_index()."aktivitas-kuliah-mahasiswa/edit/'+aData[indek]+' class=\"btn btn-primary btn-sm edit_data \" data-toggle=\"tooltip\" title=\"Edit\"><i class=\"fa fa-pencil\"></i></a>";
              } else {
                  $edit ="";
              }
            if ($role_act['del_act']=='Y') {
                $del = "<button data-id='+aData[indek]+' data-uri=".base_admin()."modul/aktivitas_kuliah_mahasiswa/aktivitas_kuliah_mahasiswa_action.php".' class="btn btn-danger hapus_dtb_notif btn-sm" data-toggle="tooltip" title="Hapus" data-variable="dtb_aktivitas_kuliah_mahasiswa"><i class="fa fa-trash"></i></button>';
            } else {
                $del="";
            }
                             }
      ...
      var dtb_aktivitas_kuliah_mahasiswa = $("#dtb_aktivitas_kuliah_mahasiswa").DataTable({
           "fnCreatedRow": function( nRow, aData, iDataIndex ) {
            ...
            $('td:eq('+indek+')', nRow).html('<a href="<?=base_index();?>aktivitas-kuliah-mahasiswa/detail/'+aData[indek]+'"  class="btn btn-success btn-sm" data-toggle="tooltip" title="Detail"><i class="fa fa-eye"></i></a> <?=$edit;?> <?=$del;?>');
  ...
  $('#dtb_aktivitas_kuliah_mahasiswa').on('draw.dt', function() {
          init_selected()
      });
  ...
  $(document).on('click', '#dtb_aktivitas_kuliah_mahasiswa tbody tr td', function(event) {
