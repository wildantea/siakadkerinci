<!-- Content Header (Page header) -->
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><?php echo $lang["add_button"];?> Aktivitas Kuliah Mahasiswa</li>
        </ol>
    </section>
      ...
      <div class="col-lg-12">
        <div class="box box-solid box-primary">
          <div class="box-header">
            <h3 class="box-title"><?php echo $lang["add_button"];?> Aktivitas Kuliah Mahasiswa</h3>
          ...
          <span class="isi_warning"></span>
            ...
            <form id="input_aktivitas_kuliah_mahasiswa" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/aktivitas_kuliah_mahasiswa/aktivitas_kuliah_mahasiswa_action.php?act=in">
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="sks_semester" placeholder="sks_semester" class="form-control" >
                </div>
              </div><!-- /.form-group -->
...
<script type="text/javascript">
    ...
    $("#input_aktivitas_kuliah_mahasiswa").validate({
