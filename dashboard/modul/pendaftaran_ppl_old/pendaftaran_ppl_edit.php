<!-- Content Header (Page header) -->
              <section class="content-header">
                  <h1>Pendaftaran PPL</h1>
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Edit Pendaftaran PPL</li>
                    </ol>
              </section>
                  ...
                  <div class="col-lg-12">
                      <div class="box box-solid box-primary">
                          <div class="box-header">
                              <h3 class="box-title">Edit Pendaftaran PPL</h3>
                      ...
                      <div class="box-body">
                       <div class="alert alert-danger error_data" style="display:none">
                        ...
                        <span class="isi_warning"></span>
                          ...
                          <form id="edit_pendaftaran_ppl" method="post" class="form-horizontal" action="<?=base_admin();?>modul/pendaftaran_ppl/pendaftaran_ppl_action.php?act=up">
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="kode_fak" value="<?=$data_edit->kode_fak;?>" class="form-control" >
                </div>
              </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="kode_jur" value="<?=$data_edit->kode_jur;?>" class="form-control" >
                </div>
              </div><!-- /.form-group -->
