<!-- Content Header (Page header) -->
                <section class="content-header">
                   ...
                   <ol class="breadcrumb">
                        ...
                        <li class="active">Detail Komponen Penilaian</li>
                    </ol>
                </section>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="box box-solid box-primary">
                            ...
                            <h3 class="box-title">Detail Komponen Penilaian</h3>
            ...
            <div class="form-group">
                ...
                <?php if ($data_edit->isShow=="1") {
                  ...
                  <?php
                      ...
                      <a href="<?=base_index();?>komponen-penilaian" class="btn btn-success "><i class="fa fa-step-backward"></i> <?php echo $lang["back_button"];?></a>
