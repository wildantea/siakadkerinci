...
<style type="text/css"> .datepicker {z-index: 1200 !important; } </style>
 <div class="alert alert-danger error_data" style="display:none">
      ...
      <form id="input_data_bank" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/data_bank/data_bank_action.php?act=in">
                      
              <div class="form-group">
                <label for="Kode Bank" class="control-label col-lg-2">Kode Bank <span style="color:#FF0000">*</span></label>
                <div class="col-lg-10">
                  <input type="text" name="kode_bank" placeholder="Kode Bank" class="form-control" required>
                </div>
              </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="nomor_rekening" placeholder="Nomor Rekening" class="form-control" required>
                </div>
              </div><!-- /.form-group -->
