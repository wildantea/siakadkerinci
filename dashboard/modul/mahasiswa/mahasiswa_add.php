    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="box box-solid box-primary">
          ...
          <div class="box-body">
            <form id="input_mahasiswa" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/mahasiswa/mahasiswa_action.php?act=in">
...
<div class="form-group">
          ...
          <div class="form-group">
              ...
              <div class="col-lg-10">
                <input type="text" id="tgl1" data-rule-date="true" name="tgl_masuk_sp" placeholder="Tanggal Masuk " class="form-control">
              </div>
          </div><!-- /.form-group -->
                    ...
                    <label for="radio2" style="padding-left: 5px;">
                     ...
                     <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-lg-10">
                          <input type="password" id="password_baru" name="password_baru" placeholder="Password" class="form-control" required > 
                        </div>
                      </div><!-- /.form-group -->
                      <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="tmpt_lahir" placeholder="Tempat Lahir" class="form-control" >
                </div>
              </div><!-- /.form-group -->
          ...
          <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="jln" placeholder="Alamat" class="form-control" >
                </div>
              </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="nm_dsn" placeholder="Nama Dusun" class="form-control" >
                </div>
              </div><!-- /.form-group -->
...
") as $isi) {
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="telepon_rumah" placeholder="Telepon Rumah" class="form-control" >
                </div>
              </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="telepon_seluler" placeholder="Telepon Seluler" class="form-control" >
                </div>
              </div><!-- /.form-group -->
          ...
          <div class="form-group">
              ...
              <div class="col-lg-10">
                <input type="text" id="tgl3" data-rule-date="true" name="tgl_lahir_ayah" placeholder="Tanggal Lahir ayah" class="form-control" >
              </div>
          </div><!-- /.form-group -->
          <div class="form-group">
...
<div class="form-group">
            ...
            <select name="id_penghasilan_ayah" data-placeholder="Pilih penghasilan wali ..." class="form-control chzn-select" tabindex="2" >
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="nm_ibu_kandung" placeholder="Ibu Kandung" class="form-control" >
                </div>
              </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="nik_ibu_kandung" placeholder="NIK Ibu Kandung" class="form-control" >
                </div>
              </div><!-- /.form-group -->
          ...
          <div class="form-group">
              ...
              <div class="col-lg-10">
                <input type="text" id="tgl4" data-rule-date="true" name="tgl_lahir_ibu" placeholder="Tanggal Lahir Ibu" class="form-control" >
              </div>
          </div><!-- /.form-group -->
          <div class="form-group">
...
<div class="form-group">
          ...
          <div class="form-group">
              ...
              <div class="col-lg-10">
                <input type="text" id="tgl5" data-rule-date="true" name="tgl_lahir_wali" placeholder="Tanggal Lahir Wali" class="form-control" >
              </div>
          </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="nik_wali" placeholder="nik_wali" class="form-control" >
                </div>
              </div><!-- /.form-group -->
          ...
          <div class="form-group">
              ...
              <div class="col-lg-10">
                <input type="text" id="tgl6" data-rule-date="true" name="id_jenjang_pendidikan_wali" placeholder="Pendidikan Wali" class="form-control" >
              </div>
          </div><!-- /.form-group -->
          <div class="form-group">
...
<div class="form-group">
            ...
            <select name="dosen_pemb" data-placeholder="Pilih dosen_pemb ..." class="form-control chzn-select" tabindex="2">
               ...
               <?php foreach ($db->fetch_all("dosen") as $isi) {
                ...
                <div class="radio radio-success radio-inline">
                  <input type="radio" name="kewarganegaraan"  id="radio3" value="WNI" >
                ...
                <div class="radio radio-success radio-inline">
                  <input type="radio" name="kewarganegaraan"  id="radio4" value="WNA" >
                    <label for="radio4" style="padding-left: 5px;">
                      WNA
                    </label>
                </div>
    ...
    <div class="col-lg-10">
      ...
      <div class="radio radio-success radio-inline">
        <input type="radio" name="status"  id="radio1status" value="CM" >
      ...
      <div class="radio radio-success radio-inline">
        <input type="radio" name="status"  id="radio2status" value="M" >
    ...
    $("#input_mahasiswa").validate({
        ...
        submitHandler: function(form) {
            ...
            $(form).ajaxSubmit({
                ...
                data: $("#input_mahasiswa").serialize(),
