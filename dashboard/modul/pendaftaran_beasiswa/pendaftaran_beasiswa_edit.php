  ...
  <style type="text/css"> .datepicker {z-index: 1200 !important; } </style>
            <form id="edit_pendaftaran_beasiswa" method="post" class="form-horizontal" action="<?=base_admin();?>modul/pendaftaran_beasiswa/pendaftaran_beasiswa_action.php?act=up">
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="nim_beasiswamhs" value="<?=$data_edit->nim_beasiswamhs;?>" class="form-control" required>
                </div>
              </div><!-- /.form-group -->
              <div class="form-group">
                        <label for="Jenis Beasiswa" class="control-label col-lg-2">Jenis Beasiswa <span style="color:#FF0000">*</span></label>
                        <div class="col-lg-10">
              <select name="id_beasiswajns" data-placeholder="Pilih Jenis Beasiswa..." class="form-control chzn-select" tabindex="2" required>
               <option value=""></option>
...
<div class="form-group">
                        ...
                        <div class="col-lg-10">
              <select name="id_beasiswa" data-placeholder="Pilih Beasiswa..." class="form-control chzn-select" tabindex="2" >
               <option value=""></option>
               <?php foreach ($db->fetch_all("beasiswa") as $isi) {

                  if ($data_edit->id_beasiswa==$isi->id_beasiswa) {
                    echo "<option value='$isi->id_beasiswa' selected>$isi->nama_beasiswa</option>";
                  } else {
                  echo "<option value='$isi->id_beasiswa'>$isi->nama_beasiswa</option>";
                    }
               } ?>
              </select>
          </div>
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="ipk_beasiswamhs" value="<?=$data_edit->ipk_beasiswamhs;?>" class="form-control" required>
                </div>
              </div><!-- /.form-group -->
