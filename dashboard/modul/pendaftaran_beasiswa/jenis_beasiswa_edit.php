...
$data_edit = $db->fetch_single_row("beasiswa_jenis","id_beasiswajns",$_POST['id_data']);
?>
  <style type="text/css"> .datepicker {z-index: 1200 !important; } </style>
            <form id="edit_pendaftaran_beasiswa" method="post" class="form-horizontal" action="<?=base_admin();?>modul/pendaftaran_beasiswa/pendaftaran_beasiswa_action.php?act=up_jns">
                            
              <div class="form-group">
                <label for="NIM" class="control-label col-lg-2">Jenis Beasiswa <span style="color:#FF0000">*</span></label>
                <div class="col-lg-10">
                  <input type="text" name="jenis_beasiswa" placeholder="Jenis Beasiswa" class="form-control" value="<?=$data_edit->jenis_beasiswajns;?>" required>
                </div>
              </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <textarea class="form-control" name="keterangan" rows="10" placeholder="Keterangan Beasiswa"><?=$data_edit->keterangan;?></textarea>
                </div>
              </div><!-- /.form-group -->
              
              <input type="hidden" name="id" value="<?=$data_edit->id_beasiswajns;?>">
