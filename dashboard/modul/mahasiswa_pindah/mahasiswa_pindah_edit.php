...
$data_edit = $db->fetch_single_row("mhs_pindah","id",$_POST['id_data']);
?>
  <style type="text/css"> .datepicker {z-index: 1200 !important; } </style>
   <div class="alert alert-danger error_data" style="display:none">
          ...
          <span class="isi_warning"></span>
            ...
            <form id="edit_mahasiswa_pindah" method="post" class="form-horizontal" action="<?=base_admin();?>modul/mahasiswa_pindah/mahasiswa_pindah_action.php?act=up">
                            
              <div class="form-group">
                <label for="Nim Lama" class="control-label col-lg-2">Nim Lama </label>
                <div class="col-lg-10">
                  <input type="text" name="nim_lama" value="<?=$data_edit->nim_lama;?>" class="form-control" >
                </div>
              </div><!-- /.form-group --> 
              <div class="form-group">
                <label for="NIM Baru" class="control-label col-lg-2">Angkatan Lama </label>
                <div class="col-lg-10">
                  <input type="text" name="angkatan_lama" value="<?=$data_edit->angkatan_lama;?>"  placeholder="Angkatan Lama (contoh : 20201)" class="form-control" >
                </div>
              </div>
              <div class="form-group">
                <label for="NIM Baru" class="control-label col-lg-2">Angkatan Baru </label>
                <div class="col-lg-10">
                  <input type="text" name="angkatan_baru" value="<?=$data_edit->angkatan_baru;?>"  placeholder="Angkatan Baru (contoh : 20211)" class="form-control" >
                </div>
              </div> 
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="nama_mhs" value="<?=$data_edit->nama_mhs;?>" class="form-control" >
                </div>
              </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="nim_baru" value="<?=$data_edit->nim_baru;?>" class="form-control" >
                </div>
              </div><!-- /.form-group -->
               ...
               <div class="form-group">  
                ...
                <div class="col-lg-10">
                  <label><input type="radio" name="jenis_pindah" class="show-kampus" value="internal" <?php 
                  if($data_edit->jenis_pindah=='internal') echo 'checked'  ?>>&nbsp;Internal&nbsp;</label>
                  <label><input type="radio" name="jenis_pindah" class="show-kampus" value="eksternal" <?php 
                  if($data_edit->jenis_pindah=='eksternal') echo 'checked'  ?>>&nbsp;Eksternal&nbsp;</label> 
                </div> 
              </div><!-- /.form-group -->

              <?php
              $display = '';
              if ($data_edit->jenis_pindah=='internal') {
                $display = 'style="display: none"';
              }
              ?>


                             <div id="form_kampus_lama" <?=$display;?>>
              <div class="form-group" >
                  ...
                  <div class="col-lg-10">
                    ...
                    <?php
                      $kampuss = $db->query("select * from satuan_pendidikan where npsn='$data_edit->kode_pt_asal'");
...
<!-- 
                    <div class="form-group">
                      ...
                      <div class="col-lg-10">
                        <input type="text" name="kampus_lama" value="<?=$data_edit->kampus_lama;?>" class="form-control" >
                      </div>
                    </div> -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="jurusan_lama" value="<?=$data_edit->jurusan_lama;?>" class="form-control" >
                </div>
              </div><!-- /.form-group -->
              <div class="form-group">
              ...
              <div class="col-lg-3">
                <div class="input-group date" id="tgl1">
                    <input type="text" class="form-control" value="<?=$data_edit->tgl_pindah;?>" name="tgl_pindah"  />
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="no_sk" value="<?=$data_edit->no_sk;?>" class="form-control" >
                </div>
              </div><!-- /.form-group -->
...
<script type="text/javascript">
  ...
  formatInputTooShort: "Cari & Pilih Asal Kampus"
    ...
    $("#edit_mahasiswa_pindah").validate({
