...
<style type="text/css"> .datepicker {z-index: 1200 !important; } </style>
 <div class="alert alert-danger error_data" style="display:none">
      ...
      <form id="input_periode_update_biodata" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/periode_update_biodata/periode_update_biodata_action.php?act=in">
...
<script type="text/javascript">
    ...
    $("#input_periode_update_biodata").validate({
