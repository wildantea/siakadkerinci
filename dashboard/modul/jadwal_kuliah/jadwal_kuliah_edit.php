<!-- Content Header (Page header) -->
              ...
              <div class="row">
                  <div class="col-lg-12">
                      ...
                      <div class="box-body">
                          <form id="edit_jadwal_kuliah" method="post" class="form-horizontal" action="<?=base_admin();?>modul/jadwal_kuliah/jadwal_kuliah_action.php?act=up">
                            
              <div class="form-group">
                <label for="Kelas" class="control-label col-lg-2">Kelas</label>
                <div class="col-lg-10">
                  <input type="text" name="kelas_id" value="<?=$data_edit->kelas_id;?>" class="form-control" >
                </div>
              </div><!-- /.form-group -->
          ...
          <div class="form-group">
              ...
              <div class="col-lg-10">
                <input type="text" data-rule-number="true" name="jam_mulai" value="<?=$data_edit->jam_mulai;?>" class="form-control" >
              </div>
          </div><!-- /.form-group -->
          ...
          <div class="form-group">
              ...
              <div class="col-lg-10">
                <input type="text" data-rule-number="true" name="jam_selesai" value="<?=$data_edit->jam_selesai;?>" class="form-control" >
              </div>

          </div><!-- /.form-group -->

          <input type="hidden" name="id" value="<?=$data_edit->jadwal_id;?>">
                            <div class="form-group">
    ...
    $("#edit_jadwal_kuliah").validate({
        ...
        submitHandler: function(form) {
            ...
            $(form).ajaxSubmit({
                ...
                data: $("#edit_jadwal_kuliah").serialize(),
