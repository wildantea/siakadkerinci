<!-- Content Header (Page header) -->
              ...
              <div class="row">
                  <div class="col-lg-12">
                      ...
                      <div class="box-body">
                          <form id="edit_program_studi" method="post" class="form-horizontal" action="<?=base_admin();?>modul/program_studi/program_studi_action.php?act=up">

          
          <div class="form-group">
              <label for="Kode Jurusan Dikti" class="control-label col-lg-2">Kode Prodi Dikti <span style="color:#FF0000">*</span></label>
              <div class="col-lg-10">
                <input type="text" data-rule-number="true" name="kode_dikti" value="<?=$data_edit->kode_dikti;?>" class="form-control" required>
              </div>
          </div><!-- /.form-group -->
              <div class="form-group">
                <label for="Nama Program Studi" class="control-label col-lg-2">Nama Program Studi <span style="color:#FF0000">*</span></label>
                <div class="col-lg-10">
                  <input type="text" name="nama_jur" value="<?=$data_edit->nama_jur;?>" class="form-control" required>
                </div>
              </div><!-- /.form-group -->
          <div class="form-group">
...
'N' => 'Tidak Aktif',
                     ...
                     foreach ($option as $isi => $val) {
                        ...
                        if ($data_edit->status==$isi) {
                          echo "<option value='$data_edit->status' selected>$val</option>";
                        } else {
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="nama_jur_asing" value="<?=$data_edit->nama_jur_asing;?>" class="form-control" >
                </div>
              </div><!-- /.form-group -->
          ...
          <div class="form-group">
              ...
              <div class="col-lg-1">
                <input type="text" data-rule-number="true" name="sks_lulus" maxlength="3" value="<?=$data_edit->sks_lulus;?>" class="form-control" >
              </div>
          </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="web" value="<?=$data_edit->web;?>" class="form-control" >
                </div>
              </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" id="tgl2" name="tgl_berdiri" value="<?=$data_edit->tgl_berdiri;?>" class="form-control" >
                </div>
              </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="no_sk_dikti" value="<?=$data_edit->no_sk_dikti;?>" class="form-control" >
                </div>
              </div><!-- /.form-group -->
          ...
          <div class="form-group">
              ...
              <div class="col-lg-10">
                <input type="text" id="tgl1" data-rule-date="true" name="tgl_sk_dikti" value="<?=$data_edit->tgl_sk_dikti;?>" class="form-control" >
              </div>
          </div><!-- /.form-group -->
          <div class="form-group">
              ...
              <select name="ketua_jurusan" data-placeholder="Pilih Ka Prodi..." class="form-control chzn-select" tabindex="2" >
               ...
               <?php foreach ($db->fetch_all("dosen") as $isi) {
                  ...
                  echo "<option value='$isi->id_dosen'> $isi->nama_dosen</option>";
                            ...
                            <input type="hidden" name="id" value="<?=$data_edit->kode_jur;?>">
                            <div class="form-group">
    ...
    $("#edit_program_studi").validate({
        ...
        submitHandler: function(form) {
            ...
            $(form).ajaxSubmit({
                ...
                data: $("#edit_program_studi").serialize(),
