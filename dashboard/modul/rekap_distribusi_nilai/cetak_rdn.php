...
<?php
 $jur = $_POST['jur']; 
  ...
  $qq=$db->query("SELECT m.`nim`, m.`nama`,j.`nama_jur`, a.`jatah_sks`, a.ipk, a.`sem_id`, m.`mulai_smt`,a.akm_id FROM akm a 
...
<body onLoad="//window.print();">
  ...
  <div class="page-break">
     <table>
      <tbody><tr>
       <td><img src="http://simak.uinsgd.ac.id/gtakademik/images/logo.jpg" width="100" height="100"></td>
      <!--halaman <?= $i ?>-->
      <td>
   ...
   <h2 align="center">DAFTAR REKAPITULASI DISTRIBUSI NILAI</h2>
    <h4 align="center">Program Studi : <?= $kk->nama_jur ?> S1 - Reguler</h4>
      ...
      <table class="tabel-common" width="100%">
         <tbody><tr>
            ...
            <th width="300" scope="col">Mata Kuliah</th>
            <th width="30" scope="col">Nilai A</th>
            <th width="30" scope="col">Nilai B</th>
            <th width="30" scope="col">Nilai C</th>
            <th width="30" scope="col">Nilai D</th>
            <th width="30" scope="col">Nilai E</th>
...
<?php
          ...
          $q=$db->query("SELECT j.kode_jur,kelas.sem_id,matkul.kode_mk, j.nama_jur, kelas.kls_nama,kelas.kode_paralel,kelas.peserta_max,kelas.peserta_min,matkul.nama_mk, kelas.kelas_id,
...
WHERE j.kode_jur='$jur' AND kelas.sem_id='$sem'");
