...
?>
  <style type="text/css"> .datepicker {z-index: 1200 !important; } </style>
            <form id="edit_akm" method="post" class="form-horizontal" action="<?=base_admin();?>modul/akm/akm_action.php?act=up">
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="stat_pd" value="<?=$data_edit->stat_pd;?>" class="form-control" >
                </div>
              </div><!-- /.form-group -->
