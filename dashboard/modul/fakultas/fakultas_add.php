      ...
      <div class="col-lg-12">
        <div class="box box-solid box-primary">
          <div class="box-header">
            <h3 class="box-title">Add Fakultas</h3>
          ...
          <div class="box-body">
            <form id="input_fakultas" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/fakultas/fakultas_action.php?act=in">
                      
              <div class="form-group">
                <label for="Kode Fakultas" class="control-label col-lg-2">Kode Fakultas <span style="color:#FF0000">*</span></label>
                <div class="col-lg-10">
                  <input type="text" name="kode_fak" placeholder="Kode Fakultas" class="form-control" required>
                </div>
              </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="nama_resmi" placeholder="Nama Fakultas" class="form-control" required>
                </div>
              </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="nama_singkat" placeholder="Nama Singkat" class="form-control" required>
                </div>
              </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="nama_asing" placeholder="Nama Inggris" class="form-control" >
                </div>
              </div><!-- /.form-group -->
