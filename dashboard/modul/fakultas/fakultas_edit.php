<!-- Content Header (Page header) -->
              <section class="content-header">
                  <h1>Fakultas</h1>
                    <ol class="breadcrumb">
                        ...
                        <li>
                        <a href="<?=base_index();?>fakultas">Fakultas</a>
                        </li>
              ...
              <div class="row">
                  <div class="col-lg-12">
                      ...
                      <div class="box-body">
                          <form id="edit_fakultas" method="post" class="form-horizontal" action="<?=base_admin();?>modul/fakultas/fakultas_action.php?act=up">
                            
              <div class="form-group">
                <label for="Kode Fakultas" class="control-label col-lg-2">Kode Fakultas <span style="color:#FF0000">*</span></label>
                <div class="col-lg-10">
                  <input type="text" name="kode_fak" value="<?=$data_edit->kode_fak;?>" class="form-control" required>
                </div>
              </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="nama_resmi" value="<?=$data_edit->nama_resmi;?>" class="form-control" required>
                </div>
              </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="nama_asing" value="<?=$data_edit->nama_asing;?>" class="form-control" >
                </div>
              </div><!-- /.form-group -->
              ...
              <div class="form-group">
                        ...
                        <div class="col-lg-10">
              <select name="dekan" data-placeholder="Pilih Dekan..." class="form-control chzn-select" tabindex="2" >
               <option value=""></option>
               <?php foreach ($db->fetch_all("dosen") as $isi) {

                  if ($data_edit->dekan==$isi->id_dosen) {
                  echo "<option value='$isi->id_dosen' selected>$isi->gelar_depan $isi->nama_dosen $isi->gelar_belakang</option>";
                  } else {
                  echo "<option value='$isi->id_dosen'>$isi->gelar_depan $isi->nama_dosen $isi->gelar_belakang</option>";
                    }
               } ?>
              </select>
          </div>
                            ...
                            <input type="hidden" name="id" value="<?=$data_edit->kode_fak;?>">
                            <div class="form-group">
