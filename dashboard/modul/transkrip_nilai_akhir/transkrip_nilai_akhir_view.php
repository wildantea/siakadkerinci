...
<section class="content-header">
  <h1>Manage Transkrip Nilai Akhir</h1>
  <ol class="breadcrumb">
    <li><a href="<?=base_index();?>"><i class="fa fa-dashboard"></i> Home</a></li>
    <li><a href="<?=base_index();?>transkrip-nilai-akhir">Kelulusan</a></li>
    <li class="active">Transkrip Nilai Akhir List</li>
  </ol>
</section>
<!-- Main content -->
           ...
           <div class="col-md-6">
              <h3 class="text-center">Form Cari Mahasiswa</h3>
                ...
                ?>
                    ...
                    <div class="col-lg-4">
                      <select name="jur" class="form-control chzn-select" tabindex="2">
                        <?= $pilih_no_jur ?>
                        <?php
                ...
                <?php
                  ...
                  if (isset($_GET['jur']) || isset($_GET['nama']) || isset($_GET['nim'])) {
                   include 'table_transkrip_nilai.php';
                  }
                  ?>
              </div>
...
<script type="text/javascript">
    ...
    $('#loadnya').show();
        $.ajax({
            type: 'POST',
            url: '<?=base_admin();?>modul/transkrip_nilai_akhir/transkrip_nilai_akhir_action.php?act=cari_mhs',
