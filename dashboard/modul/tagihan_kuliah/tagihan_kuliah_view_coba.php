...
<form id="input_mahasiswa" autocomplete="off" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/tagihan_kuliah/tagihan_kuliah_action_coba.php?act=in">
              ...
              <label for="nama" class="control-label col-lg-2">Jumlah harus dibayar</label>
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-10 ">
                      ...
                      <?php
                      $data_bank = $db->query("select * from keu_bank where JSON_CONTAINS(peruntukan, '$jenjang->id_jenjang')");
                      $i=1;
