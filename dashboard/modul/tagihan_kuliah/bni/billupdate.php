...
$trx_id = '17365284001693979342';  

$amount = 30000;
$va = $prefix . $client_id . $free_digit;
$va = "9882889010705090";
...
$data_asli_update = array(
    ...
    'customer_email' => 'wildantea@gmail.com',
    'customer_phone' => '081395070845',
    'virtual_account' => $va,
    'trx_id' => $trx_id, // fill with Billing ID
    'datetime_expired' => date('c', time() - 24 * 3600), // billing will expire in 2 hours
    //'datetime_expired' => date('c', time() + 3 * 60), // billing will expire in 3 minutes
    //'description' => 'Percobaan Update Lebih Lama',
    'billing_type' => 'i',
    'type' => 'updatebilling'
);
