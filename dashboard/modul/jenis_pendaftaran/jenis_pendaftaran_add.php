...
?>
 <div class="alert alert-danger error_data" style="display:none">
      ...
      <form id="input_jenis_pendaftaran" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/jenis_pendaftaran/jenis_pendaftaran_action.php?act=in">
              ...
              <div class="form-group">
                ...
                <div class="col-lg-9">
                  <input type="text" name="nama_jenis_pendaftaran" placeholder="Nama Jenis Pendaftaran" class="form-control" required>
                </div>
              </div><!-- /.form-group -->
              <div class="form-group">
                <label for="Nama Jenis Pendaftaran" class="control-label col-lg-3">Nama Direktory <span style="color:#FF0000">*</span></label>
                <div class="col-lg-9">
                  <input type="text" name="nama_directory" class="form-control" required>
                </div>
              </div><!-- /.form-group -->    
...
<script type="text/javascript">
    ...
    $("#input_jenis_pendaftaran").validate({
