                ...
                <section class="content-header">
                    <h1>
                     User Management
                        ...
                        <li class="active">Add New User Management</li>
                    </ol>
                </section>
...
<div class="row">
    <div class="col-lg-12"> 
        <div class="box box-solid box-primary">
                                 <div class="box-header">
                                    <h3 class="box-title">Add New User Management</h3>
 ...
 <div class="alert alert-danger user_exist" style="display:none">
          ...
          <strong>Sorry Username has taken</strong> 
        </div>
 <div class="alert alert-danger user_exist" style="display:none">
          <button type="button" class="close" data-dismiss="alert">&times;</button>
          <strong>Sorry Email has registered</strong> 
        </div>
...
<div class="form-group">
 ...
 <a href="<?=base_index();?>user-management" class="btn btn-success"><i class="fa fa-step-backward"></i> Back</a>
