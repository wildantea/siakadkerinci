  ...
  /*        echo "select m.mhs_id,m.nim,m.nama,j.nama_jur,m.stat_pd from mahasiswa m
          ...
          if ($qq->rowCount()>0) {
           ...
           ?>
              ...
              <td>
                <?php
                   echo '<a href="'.base_index().'perkembangan-akademik/show-grafik/'.en($k->nim).'" data-id="'.$k->nim.'" class="btn edit_data btn-success "><i class="fa fa-area-chart"></i> Lihat Grafik</a> ';
