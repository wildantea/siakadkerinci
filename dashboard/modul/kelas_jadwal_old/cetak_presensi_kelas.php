...
LEFT JOIN dosen DO ON DO.nip=dk.id_dosen where vnk.kelas_id is not null $sem_filter $jur_filter  $hari_filter $matkul_filter $jenis_kelas");
      ...
      <tr>
        ...
        <tr>
            ...
            <tr>
               ...
               <td nowrap ="nowrap"  valign="top">:</td>
               <td nowrap ="nowrap"  valign="top"><ol style="padding:0 0 0 15;"><li> <?= $kel->nama_dosen ?> </li></ol></td>
               <td nowrap ="nowrap" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
               <td nowrap ="nowrap" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
               <td nowrap ="nowrap" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
            </tr>
      ...
      <br />
         ...
         <tr>
                  ...
                  <tr>
                     ...
                     <td style="vertical-align:middle;"><div class="nama"><?= $kel->nama_dosen ?> </div></td>
                     <td nowrap ="nowrap" >&nbsp;</td>
                     <td nowrap ="nowrap" >&nbsp;</td>
                     <td nowrap ="nowrap" >&nbsp;</td>
                     <td nowrap ="nowrap" >&nbsp;</td>
