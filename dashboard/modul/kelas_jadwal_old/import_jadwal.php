        ...
        <div class="alert isi_informasi" style="display:none;margin-bottom: 0px;">
          <button type="button" class="close" data-dismiss="alert">&times;</button>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-lg-10"> <a href="<?=base_url();?>upload/sample/template_import_jadwal.xlsx" class="btn btn-success btn-flat"><i class="fa fa-cloud-download"></i> Download Contoh Template XLS</a></div>
                      </div><!-- /.form-group -->
                      <div class="form-group">
