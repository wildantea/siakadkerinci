<!-- Content Header (Page header) -->
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Add Skala Nilai</li>
        </ol>
    </section>
      ...
      <div class="col-lg-12">
        <div class="box box-solid box-primary">
          <div class="box-header">
            <h3 class="box-title">Add Skala Nilai</h3>
          ...
          <span class="isi_warning"></span>
            ...
            <form id="input_skala_nilai" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/skala_nilai/skala_nilai_action.php?act=in">
                      
              <div class="form-group">
                <label for="Nilai Huruf " class="control-label col-lg-2">Nilai Huruf  <span style="color:#FF0000">*</span></label>
                <div class="col-lg-10">
                  <input type="text" name="nilai_huruf" placeholder="Nilai Huruf " class="form-control" required>
                </div>
              </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="nilai_indeks" placeholder="Nilai Indeks" class="form-control" required>
                </div>
              </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="bobot_nilai_min" placeholder="Bobot Nilai Minimum" class="form-control" required>
                </div>
              </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="bobot_nilai_maks" placeholder="Bobot Nilai Maksimum" class="form-control" required>
                </div>
              </div><!-- /.form-group -->
          ...
          <div class="form-group">
              ...
              <div class="col-lg-3">
                <div class="input-group date" id="tgl1">
                    <input type="text" class="form-control" name="tgl_mulai_efektif" required />
          ...
          <div class="form-group">
              ...
              <div class="col-lg-3">
                <div class="input-group date" id="tgl2">
                    <input type="text" class="form-control" name="tgl_akhir_efektif" required />
                    <span class="input-group-addon">
                        <span class="glyphicon glyphicon-calendar"></span>
                    </span>
                </div>
          ...
          <div class="form-group">
                        <label for="Progra Studi" class="control-label col-lg-2">Program Studi <span style="color:#FF0000">*</span></label>
                        <div class="col-lg-10">
            <select  id="kode_jurusan" name="kode_jurusan" data-placeholder="Pilih Progra Studi ..." class="form-control chzn-select" tabindex="2" required>
               <option value=""></option>
...
<div class="form-group">
                <label for="Tagihan Untuk Angkatan" class="control-label col-lg-2">Skala Untuk Angkatan <span style="color:#FF0000">*</span></label>
                <div class="col-lg-10">
...
?>
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
             <a href="<?=base_index();?>skala-nilai" class="btn btn-default "><i class="fa fa-step-backward"></i> <?php echo $lang["back_button"];?></a>
