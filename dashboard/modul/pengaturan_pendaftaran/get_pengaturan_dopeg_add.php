      ...
      <div class="col-lg-12">
        <div class="box box-solid box-primary">
          ...
          <span class="isi_warning"></span>
            ...
            <form id="input_pengaturan_pendaftaran" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/pengaturan_pendaftaran/pengaturan_pendaftaran_action.php?act=in_dopeg">
