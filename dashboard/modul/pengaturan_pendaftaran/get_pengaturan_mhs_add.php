...
<div class="form-group">
          ...
          <div class="form-group">
              <label for="Ada Jadwal" class="control-label col-lg-2">Ada Matakuliah Harus Sedang di Ambil </label>
              <div class="col-lg-10">
        ...
        <!--   <div class="form-group">
          ...
          <div class="form-group show-pembimbing" style="display: none">
            ...
            <div class="form-group show-isi-pembimbing" style="display: none">
  ...
  <hr>
            <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input name="harus_lunas_spp" data-on-text="Ya" data-off-text="Tidak" class="make-switch" type="checkbox" id="harus_lunas_spp">
                </div>
            </div>
          <div class="form-group show-periode-lunas" style="display:none">
            ...
            <select  id="periode_lunas" name="periode_lunas" data-placeholder="Pilih Periode lunas ..." class="form-control" tabindex="2">
               <option value="all">Periode/Semester Awal S/d Akhir Kuliah</option>
                <option value="onlyone">Hanya Periode/Semester Aktif Saat Daftar</option>
              </select>
            </div>
                      </div><!-- /.form-group -->

          <div class="form-group show-tagihan" style="display:none">
            ...
            <select id="jenis_tagihan" name="jenis_tagihan_lunas[]" data-placeholder="Pilih Jenis Tagihan Syarat ..." class="form-control chzn-select" tabindex="2" multiple="">
               <option value=""></option>
               <?php foreach ($db2->fetchAll("keu_jenis_tagihan") as $isi) {
...
<!--             <hr>
            <div class="form-group">
                <label for="Ada Penguji" class="control-label col-lg-2">Harus LULUS ICT</label>
                <div class="col-lg-10">
                  <input name="harus_lulus_ict" data-on-text="Ya" data-off-text="Tidak" class="make-switch" type="checkbox">
                </div>
            </div>
            <div class="form-group">
                <label for="Ada Penguji" class="control-label col-lg-2">Harus LULUS TOAFL (Test of Arabic as Foreign Language)</label>
                <div class="col-lg-4">
                  <input name="harus_lulus_toafl" data-on-text="Ya" data-off-text="Tidak" class="make-switch" type="checkbox" id="harus_lulus_toafl">
                </div>
            </div> 

          <div class="form-group show-nilai-toafl" style='display:none'>
              <label for="Jumlah Penguji" class="control-label col-lg-2">Minimal Nilai TOAFL</label>
              <div class="col-lg-1">
                <input type="text" data-rule-number="true" name="min_nilai_toafl" class="form-control min_nilai_toafl" required>
              </div>
              <div class="col-lg-7" style="padding-top: 6px;">
                <p class="text-aqua">Menurut Pedoman Akademik MIn Jenjang S1: 450,S2 : 475, S3 : 500</p>
            </div>
          </div> 

            <div class="form-group">
                <label for="Ada Penguji" class="control-label col-lg-2">Harus LULUS TOEFA (Test Of English For Academics)</label>
                <div class="col-lg-4">
                  <input name="harus_lulus_toefa" data-on-text="Ya" data-off-text="Tidak" class="make-switch" type="checkbox" id="harus_lulus_toefa">
                </div>
            </div> 

          <div class="form-group show-nilai-toefa" style='display:none'>
              <label for="Jumlah Penguji" class="control-label col-lg-2">Minimal Nilai TOEFA</label>
              <div class="col-lg-1">
                <input type="text" data-rule-number="true" name="min_nilai_toefa" class="form-control min_nilai_toefa" required>
              </div>
              <div class="col-lg-7" style="padding-top: 6px;">
                <p class="text-aqua">Menurut Pedoman Akademik MIn Jenjang S1: 450,S2 : 475, S3 : 500</p>
            </div>
  ...
  <hr>
          ...
          <div class="form-group">
              ...
              <div class="col-lg-10">
                 <textarea name="keterangan" class="editboxs" required></textarea>
              </div>
          </div><!-- /.form-group -->
            <div class="form-group">
...
<div class="form-group">
            <label for="Semester" class="control-label col-lg-2">Jenis Aktivitas (Dikti)</label>
              <div class="col-lg-9">
                <select id="id_jenis_aktivitas_dikti" name="id_jenis_aktivitas_dikti" data-placeholder="Pilih Jenis Atkvitias ..." class="form-control chzn-select" >
                    <option value=""></option>
                 <?php
                 $jenis_akt = $db2->query("
                                        SELECT
...
$('#harus_lunas_spp').on('switchChange.bootstrapSwitch', function (event, state) {
   if (state==true) {
    $('.show-tagihan').show();
    $('.show-periode-lunas').show();
    $('#jenis_tagihan').prop('required',true);
   } else {
    $('.show-tagihan').hide();
    $('.show-periode-lunas').hide();
    $('#jenis_tagihan').prop('required',false);
   }
});
