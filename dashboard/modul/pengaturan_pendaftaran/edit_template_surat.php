...
<div class="form-group">
 <div class="col-lg-12">
    <span class="copy-btn" data-type="text" data-text="{{nim}}"><i class="fa fa-copy"></i> NIM</span> 
    <span class="copy-btn" data-type="text" data-text="{{nama}}"><i class="fa fa-copy"></i> Nama Mahasiswa</span> 
    <span class="copy-btn" data-type="text" data-text="{{semester_mhs}}"><i class="fa fa-copy"></i> Semester MHS (1,2 dst)</span>
    <span class="copy-btn" data-type="text" data-text="{{tempat_lahir_mhs}}"><i class="fa fa-copy"></i> Tempat Lahir MHS (Solok)</span>
    <span class="copy-btn" data-type="text" data-text="{{tgl_lahir_mhs}}"><i class="fa fa-copy"></i> Tgl Lahir MHS (22 Juli 1992)</span>
    <span class="copy-btn" data-type="text" data-text="{{alamat_mhs}}"><i class="fa fa-copy"></i> Alamat MHS</span>
    <span class="copy-btn" data-type="text" data-text="{{nama_jurusan}}"><i class="fa fa-copy"></i> Jurusan</span>
    <span class="copy-btn" data-type="text" data-text="{{jenjang_pendidikan_mhs}}"><i class="fa fa-copy"></i> Jenjang Pendidikan</span>
    ...
    <?php
    //check if has pembimbing
      if ($data_edit->ada_pembimbing=='Y') {
        $pembimbing_mahasiswa = array();
      for ($i=1; $i <= $data_edit->jumlah_pembimbing; $i++) { 
      ?>
       <span class="copy-btn" data-type="text" data-text="{{pembimbing_<?=$i;?>}}"><i class="fa fa-copy"></i> Pembimbing <?=$i;?></span>
      <?php
        }
      }
        ...
        if ($data_edit->ada_judul=='Y') {
          ?>
          <span class="copy-btn" data-type="text" data-text="{{judul_ta}}"><i class="fa fa-copy"></i> Judul TA</span>
          <?php
        }
