<!-- Content Header (Page header) -->
  ...
  <div class="box box-primary">
       ...
       <form class="form-horizontal" id="filter_kelas_form" method="post" action="<?=base_admin();?>modul/pendaftaran/download_data.php" target="_blank">
        ...
        <div class="form-group">
                                ...
                                <?php
                                loopingProdi('filter_pengaturan_pendaftaran');
                                ?>
                      </select>
                    </div>
 ...
 <div class="alert alert-warning fade in error_data_delete" style="display:none">
          ...
          <i class="icon fa fa-warning"></i> <span class="isi_warning_delete"></span>
                        ...
                        <table id="dtb_pengaturan_pendaftaran" class="table table-bordered table-striped display responsive nowrap" width="100%">
                            <thead>
                                <tr>
 ...
 if ($db2->userCan("update")) {
    $edit = "<a data-id='+data+' href=".base_index()."pengaturan-pendaftaran/edit/'+data+' class=\"btn btn-primary btn-sm edit_data \" data-toggle=\"tooltip\" title=\"Edit\"><i class=\"fa fa-pencil\"></i></a>";
