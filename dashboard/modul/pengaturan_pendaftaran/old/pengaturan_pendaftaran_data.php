...
$columns = array(
    ...
    //'tb_data_pendaftaran_jenis_pengaturan.ada_bukti',
...
if (isset($_POST['jurusan'])) {
  ...
  $query = $datatable2->execQuery("select tb_data_pendaftaran_jenis.nama_jenis_pendaftaran,tb_data_pendaftaran_jenis_pengaturan.ada_jadwal,tb_data_pendaftaran_jenis_pengaturan.ada_bukti,tb_data_pendaftaran_jenis_pengaturan.ada_judul,tb_data_pendaftaran_jenis_pengaturan.ada_pembimbing,tb_data_pendaftaran_jenis_pengaturan.ada_penguji,status_aktif,tb_data_pendaftaran_jenis_pengaturan.id_jenis_pendaftaran_setting,fungsi_get_setting_prodi_pendaftaran(tb_data_pendaftaran_jenis_pengaturan.id_jenis_pendaftaran_setting) as for_jurusan  from tb_data_pendaftaran_jenis_pengaturan inner join tb_data_pendaftaran_jenis on tb_data_pendaftaran_jenis_pengaturan.id_jenis_pendaftaran=tb_data_pendaftaran_jenis.id_jenis_pendaftaran
