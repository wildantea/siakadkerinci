...
$data_edit = $db->fetch_single_row("tb_data_pendaftaran","id",$_POST['id_data']);
?>
  <style type="text/css"> .datepicker {z-index: 1200 !important; } </style>
   <div class="alert alert-danger error_data" style="display:none">
          ...
          <span class="isi_warning"></span>
            ...
            <form id="edit_pendaftaran_proposal" method="post" class="form-horizontal" action="<?=base_admin();?>modul/pendaftaran_proposal/pendaftaran_proposal_action.php?act=up">
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="attr_value" value="<?=$data_edit->attr_value;?>" class="form-control" >
                </div>
              </div><!-- /.form-group -->
...
<script type="text/javascript">
    ...
    $("#edit_pendaftaran_proposal").validate({
