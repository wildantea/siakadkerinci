...
<div class="form-group">
    ...
    <div class="col-lg-5">
        <select id="sem_puasa" name="sem_puasa" data-placeholder="Pilih Semester ..." class="form-control chzn-select"
            tabindex="2" required="">
            <option value="<?= get_sem_aktif() ?>">
                <?= get_tahun_akademik(get_sem_aktif()); ?>
            </option>
...
<div class="form-group">
    ...
    <div class="col-lg-3">
        <select id="hari_puasa" name="hari_puasa" data-placeholder="Pilih Hari ..." class="form-control" tabindex="2">
            <option value="all">Semua</option>
            <?php
            $array_hari = array(
                'senin' => 'Senin',
