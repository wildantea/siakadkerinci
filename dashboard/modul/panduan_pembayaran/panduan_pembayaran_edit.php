<!-- Content Header (Page header) -->
              <section class="content-header">
                  <h1>Panduan Pembayaran</h1>
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Edit Panduan Pembayaran</li>
                    </ol>
              </section>
                  ...
                  <div class="col-lg-12">
                      <div class="box box-solid box-primary">
                          <div class="box-header">
                              <h3 class="box-title">Edit Panduan Pembayaran</h3>
                      ...
                      <div class="box-body">
                       <div class="alert alert-danger error_data" style="display:none">
                        ...
                        <span class="isi_warning"></span>
                          ...
                          <form id="edit_panduan_pembayaran" method="post" class="form-horizontal" action="<?=base_admin();?>modul/panduan_pembayaran/panduan_pembayaran_action.php?act=up">
              ...
              <select  id="id_bank" name="id_bank" data-placeholder="Pilih Bank..." class="form-control chzn-select" tabindex="2" required>
               ...
               <?php foreach ($db->fetch_all("keu_bank") as $isi) {
                  ...
                  if ($data_edit->id_bank==$isi->kode_bank) {
                    echo "<option value='$isi->kode_bank' selected>$isi->nama_singkat</option>";
                  } else {
          ...
          <div class="form-group">
              ...
              <div class="col-lg-10">
                <textarea id="editbox" name="isi_panduan" class="editbox"required><?=$data_edit->isi_panduan;?> </textarea>
              </div>
          </div><!-- /.form-group -->
          ...
          <div class="form-group">
              ...
              <div class="col-lg-1">
                <input type="text" data-rule-number="true" name="urutan" value="<?=$data_edit->urutan;?>" class="form-control" required>
              </div>
          </div><!-- /.form-group -->
...
<script type="text/javascript">
    ...
    $("#edit_panduan_pembayaran").validate({
