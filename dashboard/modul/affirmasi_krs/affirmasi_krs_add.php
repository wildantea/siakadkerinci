...
.ui-autocomplete {
 ...
 .datepicker {z-index: 1200 !important; } </style>
 <div class="alert alert-danger error_data" style="display:none">
          <button type="button" class="close" data-dismiss="alert">&times;</button>
          <span class="isi_warning"></span>
        </div>
      <form id="input_affirmasi_krs" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/affirmasi_krs/affirmasi_krs_action.php?act=in">
    ...
    <div class="form-group att-tambahan" style="display: none">
          ...
          <div class="col-lg-4">
            <input type="text" id="jurusan" name="jurusan" class="form-control" readonly>
              ...
              <div class="form-group">
                        <label for="Periode" class="control-label col-lg-2">Periode IRS<span style="color:#FF0000">*</span></label>
                        <div class="col-lg-10">
          ...
          <div class="form-group">
              ...
              <div class="col-lg-10">
                <textarea class="form-control col-xs-12" rows="5" name="ket_affirmasi" ></textarea>
              </div>
          </div><!-- /.form-group -->
