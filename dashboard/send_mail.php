...
$q = $db->query("select * from send_ulang_ppg where is_send='N' limit 1");
  ...
  if ($email_data->login=='Y') {
          ...
          $body = "<img src='https://press.iainkerinci.ac.id/sites/press.iainkerinci.ac.id/files/logo_iain_progresif_2023.png' style='height:100px' /><br><h2 >Selamat</h2>
                      ...
                      <table>
                        ...
                        <tr>
                          <td>NIM</td><td>:</td><td>".$k->username."</td>
                        </tr>
                        <tr> 
                          <td>Username</td><td>:</td><td>".$k->username."</td>
                        </tr> 
                        <tr> 
                          <td>Password</td><td>:</td><td>".$k->password."</td> 
                        </tr> 
                        <tr>
         ...
         $subject = "Akun SIAKAD IAIN Kerinci";
                  ...
                  try {
                    ...
                    $db->update('send_ulang_ppg',array('is_send' => 'Y'),'id',$k->id);  
                 echo 'sukses';
