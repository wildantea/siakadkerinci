...
class New_dtable extends New_db
{
    ...
    public function setTotalRecord($sql_for_counting,$type_record,$prepare_data=null)
    {
        ...
        } elseif ($this->is_union) {
            $count_data = $this->fetchCustomSingle("select count(*) as jml $from (".$sql_for_counting.") as union_result",$prepare_data);
            $query_count = "select count(*) as jml $from (".$sql_for_counting.") as union_result";
        } else {
