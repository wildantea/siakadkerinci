...
foreach ($data as $isi) {
      ...
      <?php
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-lg-10">
                          <input type="submit" class="btn btn-primary btn-flat" value="<?=$lang['submit_button'];?>">
                        </div>
                      </div><!-- /.form-group -->
                    </form>
<a href="<?=base_index();?>page" class="btn btn-success btn-flat"><i class="fa fa-step-backward"></i> <?=$lang['back_button'];?></a>
