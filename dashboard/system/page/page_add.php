...
<div class="row">
    <div class="col-lg-12">
        <div class="box box-primary">
                  ...
                  <div class="box-body">
                        <form class="form-horizontal" id="inputss" action="<?=base_admin();?>system/page/input_page.php" method="post">
                     ...
                     <option value="page">Page</option>
                        ...
                        <div class="col-lg-10">
                          <select data-placeholder="Pilih Modul" name="parent" class="form-control chzn-select" tabindex="2">
                           ...
                           <div class="form-group">
                        <label for="text1" class="control-label col-lg-2"><?=$lang['menu_order'];?></label>
                        <div class="col-lg-4">
                          <input type="text" data-rule-number="true"  name="urutan_menu" required placeholder="Menu Order" class="form-control">
                        </div>
                      </div><!-- /.form-group -->
                         <div class="form-group">
        ...
        <select id="album_table" data-placeholder="Pilih Table" onChange="get_album(this.value)" name="album_table" class="form-control chzn-select" tabindex="2">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-lg-10">
                          <a class="btn btn-default" href="<?=base_index();?>page"><i class="fa fa-backward"></i> Kembali</a>
                          <input type="submit" class="btn btn-primary btn-flat" value="Submit Page">
                        </div>
                      </div><!-- /.form-group -->
                    </form>
                  </div>
