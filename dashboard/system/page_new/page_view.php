...
<?php
 function buildMenuPage($url,$parent, $menu)
    {
       $html = "";
       $class_page = "";
...
?>
    <div class="menu-box">
        <form id="simpan_urutan" method="post" class="form-horizontal">
...
foreach ($db2->query("select * from sys_menu where tampil='N' order by parent,urutan_menu asc ") as $items) {
...
echo buildMenuPage(uri_segment(0),0, $menu);
...
<!--               <div class="form-group">
                <div class="col-lg-12">
                  ...
                  <span class="btn btn-primary save-data"><i class="fa fa-save"></i> Simpan urutan</span>
                  </div>
                </div>
              </div> -->
</form>
...
$(document).ready(function(){
            ...
            $('.save-data').click(function(e){
                ...
                // list = $(this).nestedSortable('toHierarchy', {startDepthCount: 0});
                  ...
                  $.ajax({
                        url: "<?=base_admin();?>modul/page/page_action.php?act=sorting",
                        type: 'POST',
                        data: {sorting : hiered},
                        success: function (data) {
                            $(".notif_top_up").fadeIn();
