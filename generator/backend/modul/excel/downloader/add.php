                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="<?=base_index();?>modul/excel">Download Builder</a></li>
                        <li class="active">Add Downloader</li>
                    </ol>
                </section>
...
<div class="row">
    <div class="col-lg-12">
        <div class="box box-primary">
                  ...
                  <div class="box-body">
                        <form class="form-horizontal" id="input_downloader" action="<?=base_admin();?>modul/excel/downloader/create_file.php" method="post">
                      ...
                      <div class="another_choice">
                         ...
                         <div class="form-group">
                        <label class="control-label col-lg-2">Source Table</label>
                        <div class="col-lg-10">
                          <select id="main_table" data-placeholder="Pilih Table" onChange="fetch_table(this.value)" name="table" class="form-control chzn-select" tabindex="2">
                            ...
                            <?php foreach ($db2->query('show table status') as $tb) {
                      ...
                      <div class="form-group">
                        <div class="col-lg-10">
                          <input type="submit" class="btn btn-primary btn-flat" value="Create Downloader">
                        </div>
                      </div><!-- /.form-group -->
                    </form>
                  </div>
...
//type menu
  ...
  function fetch_table(val)
  {
    if (val!='') {
         $.ajax({
      url: "<?=base_admin();?>modul/excel/downloader/source_table.php?tb="+val,
      ...
      $.ajax({
        url: "<?=base_admin();?>modul/excel/downloader/for_view.php?tb="+val,
        success:function(data){
        //  alert(data);
          $("#isi_view").html(data);
        }
  ...
  function add_join()
  {
    var tb = $('#main_table').find(":selected").text();
     $.ajax({
      ...
      //?tb="+tb+"&col="+col
      url: "<?=base_admin();?>modul/excel/downloader/isi_join.php?prev_tb="+tb,
      success:function(data){
