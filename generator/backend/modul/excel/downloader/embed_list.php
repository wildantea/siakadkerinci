...
<input type="checkbox" class="dipilih1" id="checked1_<?=$_GET['tb'].'_'.$col->Field;?>" name="dipilih1[<?=$_GET['tb'];?>.<?=$col->Field;?>]" value="<?=$col->Field;?>#<?=$col->Type;?>" onClick="copy_to1('<?=$_GET['tb']?>','<?=$col->Field?>','')">
                     <label>&nbsp;</label>
                    </div>
