                ...
                <section class="content-header">
                    <h1>
                       Create Excel/Filter Builder
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li><a href="<?=base_index();?>modul/excel">Excel/Filter Builder</a></li>
...
<div class="row">
    <div class="col-lg-12">
        <div class="box box-primary">
                  ...
                  <div class="box-body">
                    <div class="debug"></div>
                        <form class="form-horizontal" id="input_excels" action="<?=base_admin();?>modul/excel/excel/create_page.php" method="post" target="_blank">
...
$("#input_excel").submit(function(e) {
  ...
  function fetch_table(val)
  {
    if (val!='') {
         $.ajax({
      url: "<?=base_admin();?>modul/excel/excel/get_table.php?tb="+val,
      success:function(data){
      //  alert(data);
        $("#isi_table").html(data);
      }
      ...
      $.ajax({
        url: "<?=base_admin();?>modul/excel/excel/for_view.php?tb="+val,
        success:function(data){
        //  alert(data);
          $("#isi_view").html(data);
        }
  ...
  function copy_to(table,col)
  {
    if(document.getElementById("checked_"+table+"_"+col).checked) {
         ...
         $("#length_"+table+"_"+col).prop('required',true);
         $("#contoh_"+table+"_"+col).prop('required',true);
         $("#komentar_"+table+"_"+col).prop('required',true);
    }
    else {
        $("#label_"+table+"_"+col).val('');
        $("#requiredcheck_"+table+"_"+col).hide();
        $("#length_"+table+"_"+col).prop('required',false);
        $("#contoh_"+table+"_"+col).prop('required',false);
        $("#komentar_"+table+"_"+col).prop('required',false);
    }
...
function id_generator() {
  ...
  function isi_kanan(val,prev_tb)
  {
    ...
    $.ajax({
     ...
     $.ajax({
      //?tb="+tb+"&col="+col
      url: "<?=base_admin();?>modul/excel/excel/embed_list.php?tb="+val,
      success:function(data){
