              ...
              <section class="content-header">
                  <h1>Upload Drive</h1>
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><?php echo $lang["edit"];?> Upload Drive</li>
                    </ol>
              </section>
                  ...
                  <div class="col-lg-12">
                      <div class="box box-solid box-primary">
                          <div class="box-header">
                              <h3 class="box-title"><?php echo $lang["edit"];?> Upload Drive</h3>
                      ...
                      <div class="box-body">
                       <div class="alert alert-danger error_data" style="display:none">
                        ...
                        <span class="isi_warning"></span>
                          ...
                          <form id="edit_upload_drive" method="post" class="form-horizontal" action="<?=base_admin();?>modul/upload_drive/upload_drive_action.php?act=up">
                ...
                <div class="fileinput fileinput-new" data-provides="fileinput">
                            <div class="input-group">
                              ...
                              <span class="input-group-addon btn btn-default btn-file"><span class="fileinput-new">Select file</span> <span class="fileinput-exists">Change</span>
                                <input type="file" name="file" class="file-upload-data">
                              </span>
                              <a href="#" class="input-group-addon btn btn-default fileinput-exists" data-dismiss="fileinput">Remove</a>

                            </div>
                             <a href="../../../upload/upload_drive/<?=$data_edit->file?>"><?=$data_edit->file?></a>
                          </div>
                        </div>
                      </div><!-- /.form-group -->
