...
<div class="row">
    <div class="col-lg-12">
        <div class="box box-primary">
                  ...
                  <div class="box-body">
                        <form class="form-horizontal" id="inputss" action="<?=base_admin();?>modul/service/input_page.php" method="post">
...
//type menu
  ...
  function fetch_table(val)
  {
    if (val!='') {
         $.ajax({
      url: "<?=base_admin();?>modul/service/get_table.php?tb="+val,
      ...
      $.ajax({
        url: "<?=base_admin();?>modul/service/for_view.php?tb="+val,
        success:function(data){
        //  alert(data);
          $("#isi_view").html(data);
        }
...
function id_generator() {
  ...
  function isi_kanan(val,prev_tb)
  {
    ...
    $.ajax({
     ...
     $.ajax({
      //?tb="+tb+"&col="+col
      url: "<?=base_admin();?>modul/service/embed_list.php?tb="+val,
      success:function(data){
