<!-- Content Header (Page header) -->
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><?php echo $lang["add_button"];?> Downloaders</li>
        </ol>
    </section>
      ...
      <div class="col-lg-12">
        <div class="box box-solid box-primary">
          <div class="box-header">
            <h3 class="box-title"><?php echo $lang["add_button"];?> Downloaders</h3>
          ...
          <span class="isi_warning"></span>
            ...
            <form id="input_downloaders" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/downloaders/downloaders_action.php?act=in">
                      
              <div class="form-group">
                <label for="nm_pd" class="control-label col-lg-2">nm_pd </label>
                <div class="col-lg-10">
                  <input type="text" name="nm_pd" placeholder="nm_pd" class="form-control" >
                </div>
              </div><!-- /.form-group -->
