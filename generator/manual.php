...
<html>
  <head>
    ...
    <!-- Theme style -->
    <link href="backend/assets/dist/css/AdminLTE.min.css" rel="stylesheet" type="text/css" />
    <link href="backend/assets/dist/css/skins/skin-blue.min.css" rel="stylesheet" type="text/css" />
 <style type="text/css">
...
<h3>Edit Config</h3>
<p class='lead'>
    Edit config.php pada folder backend/inc/config.php
  </p>
...
//dir admin
define( "DIR_ADMIN", "website/backend/");
//main directory
...
<section id='advice'>
  ...
  <p class='lead' style="text-align:center">
    ...
    <!-- jQuery 2.1.3 -->
    <script src="backend/assets/plugins/jQuery/jQuery-2.1.3.min.js"></script>
    <!-- Bootstrap 3.3.2 JS -->
    <script src="backend/assets/bootstrap/js/bootstrap.min.js" type="text/javascript"></script>
    <!-- FastClick -->
    <script src='backend/assets/plugins/fastclick/fastclick.min.js'></script>
    <!-- AdminLTE App -->
    <script src="backend/assets/dist/js/app.min.js" type="text/javascript"></script>
    <!-- SlimScroll 1.3.0 -->
